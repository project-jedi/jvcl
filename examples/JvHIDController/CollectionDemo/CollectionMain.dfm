object CollectionDemoForm: TCollectionDemoForm
  Left = 273
  Top = 130
  Width = 600
  Height = 500
  ...
  object Description: TLabel
    ...
    Height = 26
    Caption = 
      'Shows info about the collection data of all plugged Human Interf' +
      'ace Devices (a subclass of USB devices).'#13#10'This is interesting in' +
      'formation for USB developers.'
  end
  object DeviceTree: TTreeView
    Left = 0
    Top = 40
    Width = 592
    Height = 396
