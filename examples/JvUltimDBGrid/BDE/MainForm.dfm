object frmMain: TfrmMain
  ...
  object MyUltimGrid: TJvDBUltimGrid
    ...
    TitleFont.Style = []
    OnDrawColumnCell = MyUltimGridDrawColumnCell
    TitleButtons = True
    AlternateRowColor = clInfoBk
    SelectColumn = scGrid
    TitleArrow = True
    SelectColumnsDialogStrings.Caption = 'S'#233'lection des colonnes visibles'
  ...
  object Panel1: TPanel
    ...
    object B_ResizeCols: TBitBtn
      Left = 664
      Top = 8
      Width = 109
      Height = 25
      Caption = 'Resize Cols && Rows'
      TabOrder = 4
      OnClick = B_ResizeColsClick
      NumGlyphs = 2
    end
  end
