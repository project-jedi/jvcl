...
type
  ...
  KSPROPERTY = TKsIdentifier;
  {$EXTERNALSYM KSPROPERTY}
  TKsProperty = KSPROPERTY;

  PKsMethod = ^TKsMethod;
  KSMETHOD = TKsIdentifier;
  {$EXTERNALSYM KSMETHOD}
  TKsMethod = KSMETHOD;

  PKsEvent = ^TKsEvent;
  KSEVENT = TKsIdentifier;
  {$EXTERNALSYM KSEVENT}
  TKsEvent = KSEVENT;
...
type
  ...
  IKsControl = interface(IUnknown)
    ...
    function KsProperty(const _Property: TKsProperty; PropertyLength: Cardinal;
      var PropertyData; DataLength: Cardinal; out BytesReturned: Cardinal): HResult; stdcall;
    function KsMethod(const Method: TKsMethod; MethodLength: Cardinal;
      var MethodData; DataLength: Cardinal; out BytesReturned: Cardinal): HResult; stdcall;
    function KsEvent(const Event: TKsEvent; EventLength: Cardinal;
      var EventData; DataLength: Cardinal; out BytesReturned: Cardinal): HResult; stdcall;
  end;
...
const
  ...
  {$EXTERNALSYM KSDATAFORMAT_SUBTYPE_DIRECTMUSIC}
