 ...
 ****************************************************************************)
  ...
  IDirectPlay8Address = interface(IUnknown)
    ...
    function GetComponentByName(pwszName: PWideChar; pvBuffer: Pointer; var pdwBufferSize: DWORD; out pdwDataType: DWORD): HResult; stdcall; //todo: Can (pdwDataType == NULL) ?
    function GetComponentByIndex(dwComponentID: DWORD; pwszName: PWideChar; var pdwNameLen: DWORD; pvBuffer: Pointer; var pdwBufferSize: DWORD; out pdwDataType: DWORD): HResult; stdcall; //todo: Can (pdwDataType == NULL) ?
 ...
 ****************************************************************************)
  ...
  IDirectPlay8Client = interface(IUnknown)
    ...
    function Connect(const pdnAppDesc: TDPNApplicationDesc;
      pHostAddr, pDeviceInfo: IDirectPlay8Address;
      ...
      phAsyncHandle: TDPNHandle; dwFlags: DWORD): HResult; stdcall;
  ...
  IDirectPlay8Server = interface(IUnknown)
    ...
    function Host(const pdnAppDesc: TDPNApplicationDesc; out prgpDeviceInfo: IDirectPlay8Address;
    ...
    function RemovePlayerFromGroup(idGroup, idClient: TDPNID; pvAsyncContext: Pointer;
      phAsyncHandle: PDPNHandle; dwFlags: DWORD): HResult; stdcall;
    function SetGroupInfo(dpnid: TDPNID; const pdpnGroupInfo: TDPNGroupInfo; pvAsyncContext: Pointer; phAsyncHandle: TDPNHandle; dwFlags: DWORD): HResult; stdcall;
 ...
 ****************************************************************************)
  ...
  IDirectPlay8LobbiedApplication = interface(IUnknown)
    ...
    function Close(dwFlags: DWORD): HResult; stdcall;
    function GetConnectionSettings(hConnection: TDPNHandle; pdplSessionInfo: TDPLConnectionSettings; var pdwInfoSize: DWORD; dwFlags: DWORD): HResult; stdcall;
    function SetConnectionSettings(hConnection: TDPNHandle; const pdplSessionInfo: TDPLConnectionSettings; dwFlags: DWORD): HResult; stdcall;
  end;
 ...
 ****************************************************************************)
  ...
  IDirectPlayVoiceClient = interface(IUnknown)
    ...
    function Connect(const pSoundDeviceConfig: PDVSoundDeviceConfig;
      const pdvClientConfig: PDVClientConfig; dwFlags: DWORD): HResult; stdcall;
    ...
    function GetCompressionTypes(pData: Pointer; var pdwDataSize: DWORD;
      var pdwNumElements: DWORD; dwFlags: DWORD): HResult; stdcall;
...
///////////////////////////////////////////////////////////////////////////////
///////////////////////////////////////////////////////////////////////////////
// Compatibility types for non-Borland compliant translations if DirectPlay8 //
///////////////////////////////////////////////////////////////////////////////
///////////////////////////////////////////////////////////////////////////////
