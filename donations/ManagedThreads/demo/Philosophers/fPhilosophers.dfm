object frmDiningPhilosophers: TfrmDiningPhilosophers
  ...
  object PhilosopherManager: TmtcManager
    Left = 96
    Top = 200
  end
  object PhilosopherThread: TmtcThread
    Manager = PhilosopherManager
    OnExecute = PhilosopherThreadExecute
    Left = 96
    Top = 232
  end
  object MonitorSection: TmtcMonitorSection
    Left = 136
    Top = 232
  end
  object PersonBuffer: tmtcVCLToThread
    MaxBufferSize = 5
    OnCanWrite = PersonBufferCanWrite
    Left = 136
    Top = 200
  end
  object MsgToVCL: TmtcThreadToVCL
