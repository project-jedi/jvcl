...
uses
  ...
  Dialogs, MTComponents, StdCtrls, MTThreading, ExtCtrls, ComCtrls;
...
type
  ...
  TfrmDiningPhilosophers = class(TForm)
    PhilosopherManager: TmtcManager;
    PhilosopherThread: TmtcThread;
    MonitorSection: TmtcMonitorSection;
    Memo: TMemo;
    BtnStart: TButton;
    BtnTerminate: TButton;
    PersonBuffer: tmtcVCLToThread;
    MsgToVCL: TmtcThreadToVCL;
    PhilLabel1: TLabel;
    PhilLabel2: TLabel;
    PhilLabel3: TLabel;
    PhilLabel4: TLabel;
    ...
    LblSpeed: TLabel;
    BtnClose: TButton;
    procedure PhilosopherThreadExecute(Sender: TmtcThread; MTThread: TMTThread);
...
procedure TfrmDiningPhilosophers.PhilosopherThreadExecute(Sender: TmtcThread;
  MTThread: TMTThread);
