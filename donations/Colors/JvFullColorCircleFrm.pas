...
type
  TJvFullColorCircleForm = class(TJvBaseColorCircleForm)
  ...
  protected
    ...
    procedure SetOptions(const Value: TJvFullColorCircleDialogOptions); override;
...
procedure TJvFullColorCircleForm.Loaded;
begin
  inherited Loaded;
  FExpandedWidth := Width;
end;

procedure TJvFullColorCircleForm.Collapse;
begin
...
procedure TJvFullColorCircleForm.Expand;
begin
...
procedure TJvFullColorCircleForm.SetOptions(const Value: TJvFullColorCircleDialogOptions);
var
  I: TJvAxisIndex;
...
procedure TJvFullColorCircleForm.UpdateColorSpace;
var
  I: TJvAxisIndex;
  LCaption: string;
  LColor: TJvFullColor;
...
procedure TJvFullColorCircleForm.UpdateDeltaValue;
var
  I: TJvAxisIndex;
...
procedure TJvFullColorCircleForm.RadioButtonAxisClick(Sender: TObject);
begin
  UpdateAxisSettings;
end;

procedure TJvFullColorCircleForm.UpdateAxisSettings;
var
  I: TJvAxisIndex;
  LColor: TColor;
  EnabledA, EnabledB: Boolean;
...
procedure TJvFullColorCircleForm.CheckBoxSettingsClick(Sender: TObject);
var
  Idx: TJvAxisIndex;
...
procedure TJvFullColorCircleForm.UpdateCheckBoxStates;
var
  I: TJvAxisIndex;
...
procedure TJvFullColorCircleForm.ButtonGraphicsClick(Sender: TObject);
begin
  if Expanded then
    Collapse
  else
...
procedure TJvFullColorCircleForm.ButtonApplyClick(Sender: TObject);
begin
  if Assigned(OnApply) then
    OnApply(Self);
end;

procedure TJvFullColorCircleForm.JvColorSpaceComboChange(Sender: TObject);
begin
  if not FUpdating then
    UpdateColorSpace;
end;

procedure TJvFullColorCircleForm.SetBlueDelta(const Value: TJvAxisDelta);
begin
...
procedure TJvFullColorCircleForm.SetDelta(const Value: TJvColorDelta);
begin
...
procedure TJvFullColorCircleForm.SetGreenDelta(const Value: TJvAxisDelta);
begin
...
procedure TJvFullColorCircleForm.SetRedDelta(const Value: TJvAxisDelta);
begin
...
procedure TJvFullColorCircleForm.CalcDeltaValue(ARotateColor: TJvRotateColor);
var
  I: TJvAxisIndex;
  AxisDelta: TJvAxisDelta;
...
procedure TJvFullColorCircleForm.JvColorCircleBlueColorChange(Sender: TObject);
begin
  if not FUpdating then
    CalcDeltaValue(rcBlue);
end;

procedure TJvFullColorCircleForm.JvColorCircleColorChange(Sender: TObject);
begin
  if not FUpdating then
    CalcDeltaValue(rcCommon);
end;

procedure TJvFullColorCircleForm.JvColorCircleGreenColorChange(Sender: TObject);
begin
  if not FUpdating then
    CalcDeltaValue(rcGreen);
end;

procedure TJvFullColorCircleForm.JvColorCircleRedColorChange(Sender: TObject);
begin
  if not FUpdating then
    CalcDeltaValue(rcRed);
end;

procedure TJvFullColorCircleForm.JvColorAxisConfigComboChange(Sender: TObject);
begin
  if not FUpdating then
  begin
    FUpdating := True;
...
procedure TJvFullColorCircleForm.JvColorCircleColorSpaceChange(Sender: TObject);
begin
  CalcDeltaValue(rcRed);
  CalcDeltaValue(rcGreen);
  CalcDeltaValue(rcBlue);
...
procedure TJvFullColorCircleForm.SpinEditSettingsValueChange(Sender: TObject);
var
  Idx: TJvAxisIndex;
  AxisDelta: TJvAxisDelta;
begin
...
procedure TJvFullColorCircleForm.FormKeyDown(Sender: TObject; var Key: Word;
  Shift: TShiftState);
begin
...
initialization
  InitializeStrings;
  ColorCircleBaseFormClass := TJvFullColorCircleForm;
  {$IFDEF UNITVERSIONING}
