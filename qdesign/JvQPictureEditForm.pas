...
uses
  ...
  QStdCtrls, QExtCtrls, QExtDlgs, QButtons, QTypes, QWindows,
  
  JvQMRUManager, JvQFormPlacement, {JvQClipboardMonitor,} JvQComponent,
  JvQAppStorage,
  {$IFDEF MSWINDOWS}
...
uses
  ...
  ShellAPI, LibHelp,
  {$ENDIF MSWINDOWS}
  JvQJVCLUtils, JvQJCLUtils, JvQConsts, JvQDsgnConsts, JvQDirectoryListForm, JvQTypes;
