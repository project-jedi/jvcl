...
{$UNDEF HASAUTOSIZE}
  ...
  {$ENDIF COMPILER6_UP}
  {$ENDIF VCL}
  JV_STDCONTROL_EVENTS(CustomComboBox)
  JV_STDCONTROL_EVENTS(ComboBox)
  ...
  JV_STDCONTROL_EVENTS(CustomListBox)
  JV_STDCONTROL_EVENTS(ListBox)
...
{$ENDIF COMPILER6_UP}
{$ENDIF VCL}
JV_STDCONTROL_EVENTS_IMPL(CustomComboBox)
JV_STDCONTROL_EVENTS_IMPL(ComboBox)
...
JV_STDCONTROL_EVENTS_IMPL(CustomListBox)
JV_STDCONTROL_EVENTS_IMPL(ListBox)
