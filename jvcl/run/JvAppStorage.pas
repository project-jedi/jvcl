...
begin
  ...
  {$ELSE}
  { TODO : Suspicial code: TPeristent has no virtual contructor }
...
begin
  ...
  if NameStart >= 0 then
    ...
    Result := StartsText(Name.Substring(NameStart), cItem) and (Length(Name) - NameStart > 4) and (Name[5] in DigitSymbols);
end;
{$ELSE}
var
  NameStart: PChar;
