...
type
  ...
  protected
    ...
    procedure SeTJvDockSplitterWidth(const Value: TJvDockSplitterWidth); virtual;
  ...
  public
    ...
    destructor Destroy; override;
    procedure Assign(Source: TPersistent); override;
    procedure SeTJvDockGrabbersSize_WithoutChangeSystemInfo(const Value: TJvDockGrabbersSize);
    procedure SeTJvDockSplitterWidth_WithoutChangeSystemInfo(const Value: TJvDockSplitterWidth);
  published
    property GrabbersSize: TJvDockGrabbersSize read FGrabbersSize write SeTJvDockGrabbersSize;
    property SplitterWidth: TJvDockSplitterWidth read FSplitterWidth write SeTJvDockSplitterWidth;
  end;
  ...
  protected
    ...
    procedure SetDockBaseControl(IsCreate: Boolean;
      DockBaseControl: TJvDockBaseControl); virtual;

    function DockServerWindowProc(DockServer: TJvDockServer; var Message: TMessage): Boolean; virtual;

    function DockClientWindowProc(DockClient: TJvDockClient; var Message: TMessage): Boolean; virtual;
  ...
  public
    ...
    function CreateConjoinHostAndDockControl(Control1,
      Control2: TControl; DockType: TAlign): TJvDockConjoinHostForm; virtual;
    function CreateTabHostAndDockControl(Control1,
      Control2: TControl): TJvDockTabHostForm; virtual;
...
uses Dialogs, Math, JvDockSupportProc, JvDockGlobals, JvDockInfo, JvDockVSNetStyle;
  ...
  begin
    ...
    begin
      ...
      begin
        ...
        if ADockServer.DockPanel[i] is TJvDockVSNETPanel then
        begin
          with TJvDockVSNETPanel(ADockServer.DockPanel[i]).VSChannel do
          begin
            RemoveAllBlock;
...
begin
  ...
  begin
    ...
    begin
      ...
      if (DockClient.LastDockSite is TJvDockPanel) and (NewTarget is TJvDockPanel) and (DockClient.LastDockSite <>
        NewTarget) then
      begin
...
procedure TJvDockPanel.CustomDockDrop(Source: TJvDockDragDockObject; X,
  Y: Integer);
begin
...
procedure TJvDockPanel.CustomDockOver(Source: TJvDockDragDockObject; X,
...
begin
  if (not MakeVisible and (VisibleDockClientCount > 1)) or
    (JvGlobalDockClient = nil) then Exit;
...
procedure TJvDockAdvPanel.CMUnDockClient(var Message: TCMUnDockClient);
var
  DockClient: TJvDockClient;
begin
  if JvGlobalDockIsLoading then Exit;
  with Message do
  begin
    Result := 0;
    if UseDockManager and (lbDockManager <> nil) then
...
procedure TJvDockAdvPanel.CustomDockDrop(Source: TJvDockDragDockObject; X,
  Y: Integer);
begin
...
procedure TJvDockBaseControl.WindowProc(var Message: TMessage);
begin
  if not (csDesigning in ComponentState) then
  begin
...
begin
  ...
  if (Assigned(ADockBaseControl)) and (ADockBaseControl <> Self) then
    raise EInvalidOperation.Create(Format(RsDockCannotLayAnother, [ADockBaseControl.ClassName, ClassName]));
...
procedure TJvDockServer.SetLeftSplitterStyle(
  const Value: TJvDockSplitterStyle);
begin
  FLeftSplitterStyle.Assign(Value);
end;

procedure TJvDockServer.SetTopSplitterStyle(
  const Value: TJvDockSplitterStyle);
begin
  FTopSplitterStyle.Assign(Value);
end;

procedure TJvDockServer.SetRightSplitterStyle(
  const Value: TJvDockSplitterStyle);
begin
  FRightSplitterStyle.Assign(Value);
end;

procedure TJvDockServer.SetBottomSplitterStyle(
  const Value: TJvDockSplitterStyle);
begin
...
procedure TJvDockServer.WindowProc(var Message: TMessage);
begin
...
procedure TJvDockServer.WMActivate(var Message: TWMActivate);
var
  i: Integer;
  Control: TWinControl;
begin
...
function TJvDockServer.GetDockSplitterWithAlign(
  Index: TAlign): TJvDockSplitter;
begin
  Result := nil;
  case Index of
...
procedure TJvDockClient.WindowProc(var Message: TMessage);
var
...
function TJvDockClient.CreateConjoinHostAndDockControl(
  Control1, Control2: TControl; DockType: TAlign): TJvDockConjoinHostForm;
var
...
function TJvDockClient.CreateTabHostAndDockControl(
  Control1, Control2: TControl): TJvDockTabHostForm;
var
  APage: TJvDockTabPageControl;
  OldDockWidth, OldDockHeight: Integer;
begin
...
procedure TJvDockClient.WMSize(var Message: TWMSize);
begin
...
function TJvDockClient.CreateConjoinPanelClass(
  ConjoinHost: TForm): TJvDockConjoinPanel;
begin
  Result := nil;
...
function TJvDockClient.CreateTabDockClass(
  TabHost: TForm): TJvDockTabPageControl;
begin
  Result := nil;
...
procedure TJvDockClient.WMActivate(var Message: TWMActivate);
begin
...
begin
  ...
  begin
    TJvDockCustomPanel(
      ParentForm.HostDockSite).lbDockManager.ActiveControl := ParentForm;
  end;
end;
...
procedure TJvDockClient.FormDockDrop(Source: TJvDockDragDockObject; X,
  Y: Integer);
begin
  if Assigned(DockStyle) then
...
procedure TJvDockClient.FormDockOver(Source: TJvDockDragDockObject; X,
  Y: Integer; State: TDragState; var Accept: Boolean);
begin
...
procedure TJvDockClient.DoNCButtonDown(Message: TWMNCHitMessage;
...
procedure TJvDockClient.DoNCButtonUp(Message: TWMNCHitMessage;
  Button: TMouseButton; MouseStation: TJvDockMouseStation);
begin
...
procedure TJvDockClient.DoNCMouseMove(Message: TWMNCHitMessage;
...
procedure TJvDockClient.DoNCButtonDblClk(Message: TWMNCHitMessage; Button: TMouseButton;
  MouseStation: TJvDockMouseStation);
begin
...
procedure TJvDockClient.WMNCLButtonDown(var Message: TWMNCHitMessage);
begin
...
procedure TJvDockClient.WMNCLButtonUp(var Message: TWMNCHitMessage);
begin
  DoNCButtonUp(Message, mbLeft, msFloat);
end;

procedure TJvDockClient.WMNCMButtonDown(var Message: TWMNCHitMessage);
begin
  DoNCButtonDown(Message, mbMiddle, msFloat);
end;

procedure TJvDockClient.WMNCMButtonUp(var Message: TWMNCHitMessage);
begin
  DoNCButtonUp(Message, mbMiddle, msFloat);
end;

procedure TJvDockClient.WMNCRButtonDown(var Message: TWMNCHitMessage);
begin
  DoNCButtonDown(Message, mbRight, msFloat);
end;

procedure TJvDockClient.WMNCRButtonUp(var Message: TWMNCHitMessage);
begin
  DoNCButtonUp(Message, mbRight, msFloat);
end;

procedure TJvDockClient.WMNCMOUSEMOVE(var Message: TWMNCHitMessage);
begin
  DoNCMouseMove(Message, msFloat);
end;

procedure TJvDockClient.WMNCLButtonDblClk(var Message: TWMNCHitMessage);
begin
  DoNCButtonDblClk(Message, mbLeft, msFloat);
end;

procedure TJvDockClient.WMNCMButtonDblClk(var Message: TWMNCHitMessage);
begin
  DoNCButtonDblClk(Message, mbMiddle, msFloat);
end;

procedure TJvDockClient.WMNCRButtonDblClk(var Message: TWMNCHitMessage);
begin
...
procedure TJvDockClient.DoPaintDockGrabber(
...
procedure TJvDockClient.FormGetDockEdge(Source: TJvDockDragDockObject; MousePos: TPoint; var DropAlign: TAlign);
begin
  if Assigned(DockStyle) then
...
procedure TJvDockClient.CMVisibleChanged(var Message: TMessage);
begin
end;
...
procedure TJvDockConjoinPanel.DoDockOver(Source: TDragDockObject; X,
  Y: Integer; State: TDragState; var Accept: Boolean);
begin
...
procedure TJvDockConjoinPanel.CustomDockDrop(Source: TJvDockDragDockObject; X,
  Y: Integer);
begin
  inherited CustomDockDrop(Source, X, Y);
  if Source.Control is TForm then
...
procedure TJvDockConjoinPanel.CustomDockOver(Source: TJvDockDragDockObject; X,
  Y: Integer; State: TDragState; var Accept: Boolean);
begin
  inherited CustomDockOver(Source, X, Y, State, Accept);
...
procedure TJvDockConjoinPanel.CustomGetSiteInfo(Source: TJvDockDragDockObject; Client: TControl;
  var InfluenceRect: TRect; MousePos: TPoint; var CanDock: Boolean);
begin
  CanDock := IsDockable(Self, Client, Source.DropOnControl, Source.DropAlign);
  inherited CustomGetSiteInfo(Source, Client, InfluenceRect, MousePos, CanDock);
...
procedure TJvDockConjoinPanel.CustomPositionDockRect(Source: TJvDockDragDockObject; X, Y: Integer);
begin
  inherited CustomPositionDockRect(Source, X, Y);
end;
...
function TJvDockConjoinPanel.CustomUnDock(Source: TJvDockDragDockObject; NewTarget: TWinControl;
  Client: TControl): Boolean;
begin
  ParentForm.FUnDockControl := Client;
...
procedure TJvDockConjoinPanel.ReloadDockedControl(
  const AControlName: string; var AControl: TControl);
begin
  AControl := JvDockFindDockFormWithName(AControlName);
end;

procedure TJvDockConjoinPanel.CMUnDockClient(var Message: TCMUnDockClient);
begin
  inherited;
  ...
  if VisibleDockClientCount <= 2 then
    JvDockControlForm.UpdateCaption(Self, Message.Client);
  if UseDockManager and (lbDockManager <> nil) then
    lbDockManager.ResetBounds(True);
end;
...
var
  TabPageStreamEndFlag: Integer = -10;
...
procedure TJvDockTabPageControl.CustomDockDrop(Source: TJvDockDragDockObject; X,
  Y: Integer);
var
...
procedure TJvDockTabPageControl.CustomDockOver(Source: TJvDockDragDockObject; X,
  Y: Integer; State: TDragState; var Accept: Boolean);
var
  ARect: TRect;
begin
...
procedure TJvDockTabPageControl.CustomGetSiteInfo(Source: TJvDockDragDockObject; Client: TControl;
  var InfluenceRect: TRect; MousePos: TPoint; var CanDock: Boolean);
begin
  inherited CustomGetSiteInfo(Source, Client, InfluenceRect, MousePos, CanDock);
  CanDock := IsDockable(Self, Client, Source.DropOnControl, Source.DropAlign);
...
procedure TJvDockTabPageControl.CustomPositionDockRect(
...
function TJvDockTabPageControl.CustomUnDock(Source: TJvDockDragDockObject; NewTarget: TWinControl;
  Client: TControl): Boolean;
begin
...
procedure TJvDockTabPageControl.ReloadDockedControl(
  const AControlName: string; var AControl: TControl);
begin
  AControl := JvDockFindDockFormWithName(AControlName);
end;
...
procedure TJvDockBasicStyle.FormDockDrop(DockClient: TJvDockClient; Source: TJvDockDragDockObject; X,
  Y: Integer);
var
  ARect, DRect: TRect;
  DockType: TAlign;
...
procedure TJvDockBasicStyle.FormDockOver(DockClient: TJvDockClient; Source: TJvDockDragDockObject; X,
  Y: Integer; State: TDragState; var Accept: Boolean);
var
  ARect: TRect;
begin
...
procedure TJvDockBasicStyle.FormEndDock(DockClient: TJvDockClient; Target: TObject; X, Y: Integer);
begin
...
procedure TJvDockBasicStyle.FormStartDock(DockClient: TJvDockClient; var Source: TJvDockDragDockObject);
begin
...
function TJvDockBasicStyle.DockClientWindowProc(DockClient: TJvDockClient; var Message: TMessage): Boolean;
begin
...
procedure TJvDockBasicStyle.SetConjoinServerOption(
  const Value: TJvDockBasicConjoinServerOption);
begin
  FConjoinServerOption.Assign(Value);
end;

procedure TJvDockBasicStyle.SetTabServerOption(
  const Value: TJvDockBasicTabServerOption);
begin
  FTabServerOption.Assign(Value);
end;

procedure TJvDockBasicStyle.CreateConjoinServerOption(
  var Option: TJvDockBasicConjoinServerOption);
begin
  Option := TJvDockBasicConjoinServerOption.Create(Self);
end;

procedure TJvDockBasicStyle.CreateTabServerOption(
...
procedure TJvDockBasicStyle.AssignConjoinServerOption(
  APanel: TJvDockCustomPanel);
begin
...
procedure TJvDockBasicStyle.AssignTabServerOption(
  APage: TJvDockTabPageControl);
begin
...
procedure TJvDockBasicStyle.ParentFormWindowProc(var Message: TMessage);
begin
  if not (csDesigning in ComponentState) then
  begin
    if Assigned(FOldWindowProc) then
...
procedure TJvDockBasicStyle.AddDockBaseControl(
  ADockBaseControl: TJvDockBaseControl);
begin
...
procedure TJvDockBasicStyle.RemoveDockBaseControl(
  ADockBaseControl: TJvDockBaseControl);
begin
  if ADockBaseControl = nil then Exit;
...
function TJvDockBasicStyle.GetDockBaseControlLists(
  Index: Integer): TJvDockBaseControl;
begin
...
function TJvDockBasicStyle.GetDockState(
  DockClient: TJvDockClient): Integer;
begin
  Result := JvDockState_Unknown;
  ...
  begin
    ...
    begin
      ...
      begin
        if UseDockManager and (lbDockManager <> nil) then
        begin
          if not lbDockManager.HasZoneWithControl(ParentForm) then Exit;
          DisableAlign;
          try
...
procedure TJvDockBasicServerOption.ResetDockClientOption(
  ADockClient: TJvDockClient);
begin

end;

procedure TJvDockBasicServerOption.ResetDockServerOption(
  ADockServer: TJvDockServer);
begin
...
procedure TJvDockBasicTabServerOption.ResetDockClientOption(
  ADockClient: TJvDockClient);
var
  PageControl: TJvDockTabPageControl;
begin
...
procedure TJvDockBasicTabServerOption.ResetDockServerOption(
  ADockServer: TJvDockServer);
begin

end;

procedure TJvDockBasicTabServerOption.ResetTabPageControl(
  APage: TJvDockTabPageControl);
begin
...
procedure TJvDockBasicTabServerOption.SetTabPosition(
...
constructor TJvDockBasicConjoinServerOption.Create(
...
procedure TJvDockBasicConjoinServerOption.ResetConjoinPanel(
  APanel: TJvDockConjoinPanel);
begin
...
procedure TJvDockBasicConjoinServerOption.ResetDockClientOption(
  ADockClient: TJvDockClient);
var
...
procedure TJvDockBasicConjoinServerOption.ResetDockServerOption(
  ADockServer: TJvDockServer);
var
  i: Integer;
begin
...
procedure TJvDockBasicConjoinServerOption.SeTJvDockGrabbersSize(
...
procedure TJvDockBasicConjoinServerOption.SeTJvDockGrabbersSize_WithoutChangeSystemInfo(
  const Value: TJvDockGrabbersSize);
begin
  FGrabbersSize := Value;
end;

procedure TJvDockBasicConjoinServerOption.SeTJvDockSplitterWidth(
...
procedure TJvDockBasicConjoinServerOption.SeTJvDockSplitterWidth_WithoutChangeSystemInfo(
  const Value: TJvDockSplitterWidth);
begin
  FSplitterWidth := Value;
end;

procedure TJvDockAdvTabPageControl.CMUnDockClient(
  var Message: TCMUnDockClient);
begin
  inherited;
end;

procedure TJvDockAdvTabPageControl.CustomDockDrop(Source: TJvDockDragDockObject; X,
  Y: Integer);
begin
...
procedure TJvDockAdvTabPageControl.DockDrop(Source: TDragDockObject; X,
  Y: Integer);
begin
...
procedure TJvDockAdvConjoinPanel.CMUnDockClient(var Message: TCMUnDockClient);
begin
  inherited;

end;

procedure TJvDockAdvConjoinPanel.CustomDockDrop(Source: TJvDockDragDockObject; X,
  Y: Integer);
begin
...
procedure TJvDockAdvConjoinPanel.DockDrop(Source: TDragDockObject; X,
  Y: Integer);
begin
