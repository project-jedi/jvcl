...
//    property Name;
  ...
  public
    ...
    constructor Create(Menu : TMenu); reintroduce; overload; virtual;
...
procedure TJvCustomMenuItemPainter.DefaultDrawLeftMargin(ARect: TRect; StartColor,
  EndColor: TColor);
var
  R: Integer;
begin
...
procedure TJvCustomMenuItemPainter.SetImageBackgroundColor(
  const Value: TColor);
begin
