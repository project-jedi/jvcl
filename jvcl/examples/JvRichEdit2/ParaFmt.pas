...
uses
  ...
  StdCtrls, ExtCtrls, Mask, JvRichEdit, JvMaskEdit, JvSpin;
...
procedure TParaFormatDlg.SetAttr(Paragraph: TJvParaAttributes);
begin
...
procedure TParaFormatDlg.GetAttr(Paragraph: TJvParaAttributes);
begin
