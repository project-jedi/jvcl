...
const
  ...
  Day: array [1..3] of string = ('‰ÂÌ¸', '‰Ìˇ', '‰ÌÂÈ'); // Day, Days, Days
  Month: array [1..3] of string = ('ÏÂÒˇˆ', 'ÏÂÒˇˆ‡', 'ÏÂÒˇˆÂ‚'); // Month, Months, Months
  Year: array [1..3] of string = ('„Ó‰', '„Ó‰‡', 'ÎÂÚ'); // Year, Years, Years
  Week: array [1..4] of string = ('ÌÂ‰ÂÎ˛', '2 ÌÂ‰ÂÎË', '3 ÌÂ‰ÂÎË', 'ÏÂÒˇˆ'); // Week, 2 Weeks, 3 Weeks, Month
var
  Y, M, D: Integer;
begin
  if Date = Dat then
