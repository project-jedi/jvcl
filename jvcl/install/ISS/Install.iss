...
;    Include_DelphiX     Include the binaries for Delphi X (X in 6..37)
...
#define JvclLib27    JvclLib
#define   JvclBpl27  JvclBpl
#define   JvclHpp27  JvclHpp
#define JvclLib28    JvclLib
#define   JvclBpl28  JvclBpl
#define   JvclHpp28  JvclHpp
#define JvclLib29    JvclLib
#define   JvclBpl29  JvclBpl
#define   JvclHpp29  JvclHpp
#define JvclLib37    JvclLib
#define   JvclBpl37  JvclBpl
#define   JvclHpp37  JvclHpp
#endif
...
Name: "{app}\lib\d28\win64"
Name: "{app}\lib\d28\win64\debug"
; 12
Name: "{app}\lib\d29"
Name: "{app}\lib\d29\win32"
Name: "{app}\lib\d29\win32\debug"
Name: "{app}\lib\d29\win64"
Name: "{app}\lib\d29\win64\debug"
; 13
Name: "{app}\lib\d37"
Name: "{app}\lib\d37\win32"
Name: "{app}\lib\d37\win32\debug"
Name: "{app}\lib\d37\win64"
Name: "{app}\lib\d37\win64\debug"
...
; SolidBreak; lib\Delphi 10.4
Source: {#JvclLib27}\*; DestDir: "{app}\lib\d27"; Excludes: "__history,*.txt"; Components: "IDE\Delphi27"; Flags: ignoreversion recursesubdirs sortfilesbyextension createallsubdirs solidbreak
Source: {#JvclBpl27}\*; DestDir: "{code:GetDelphiBplDir|27}"; Components: "IDE\Delphi27"; Flags: ignoreversion sortfilesbyextension
Source: {#JvclBpl27}\Win64\*; DestDir: "{code:GetDelphiBplDir|27}\Win64"; Components: "IDE\Delphi27"; Flags: ignoreversion sortfilesbyextension
Source: {#JvclHpp27}\*; DestDir: "{app}\include\d27"; Components: "IDE\Delphi27"; Flags: ignoreversion sortfilesbyextension
#endif
#ifdef Include_Delphi28
; SolidBreak; lib\Delphi 11
Source: {#JvclLib28}\*; DestDir: "{app}\lib\d28"; Excludes: "__history,*.txt"; Components: "IDE\Delphi28"; Flags: ignoreversion recursesubdirs sortfilesbyextension createallsubdirs solidbreak
Source: {#JvclBpl28}\*; DestDir: "{code:GetDelphiBplDir|28}"; Components: "IDE\Delphi28"; Flags: ignoreversion sortfilesbyextension
Source: {#JvclBpl28}\Win64\*; DestDir: "{code:GetDelphiBplDir|28}\Win64"; Components: "IDE\Delphi28"; Flags: ignoreversion sortfilesbyextension
Source: {#JvclHpp28}\*; DestDir: "{app}\include\d28"; Components: "IDE\Delphi28"; Flags: ignoreversion sortfilesbyextension
#endif
#ifdef Include_Delphi29
; SolidBreak; lib\Delphi 12
Source: {#JvclLib29}\*; DestDir: "{app}\lib\d29"; Excludes: "__history,*.txt"; Components: "IDE\Delphi29"; Flags: ignoreversion recursesubdirs sortfilesbyextension createallsubdirs solidbreak
Source: {#JvclBpl29}\*; DestDir: "{code:GetDelphiBplDir|29}"; Components: "IDE\Delphi29"; Flags: ignoreversion sortfilesbyextension
Source: {#JvclBpl29}\Win64\*; DestDir: "{code:GetDelphiBplDir|29}\Win64"; Components: "IDE\Delphi29"; Flags: ignoreversion sortfilesbyextension
Source: {#JvclHpp29}\*; DestDir: "{app}\include\d29"; Components: "IDE\Delphi29"; Flags: ignoreversion sortfilesbyextension
#endif
#ifdef Include_Delphi37
; SolidBreak; lib\Delphi 12
Source: {#JvclLib37}\*; DestDir: "{app}\lib\d37"; Excludes: "__history,*.txt"; Components: "IDE\Delphi37"; Flags: ignoreversion recursesubdirs sortfilesbyextension createallsubdirs solidbreak
Source: {#JvclBpl37}\*; DestDir: "{code:GetDelphiBplDir|37}"; Components: "IDE\Delphi37"; Flags: ignoreversion sortfilesbyextension
Source: {#JvclBpl37}\Win64\*; DestDir: "{code:GetDelphiBplDir|37}\Win64"; Components: "IDE\Delphi37"; Flags: ignoreversion sortfilesbyextension
Source: {#JvclHpp37}\*; DestDir: "{app}\include\d37"; Components: "IDE\Delphi37"; Flags: ignoreversion sortfilesbyextension
#endif
...
#ifdef Include_Delphi27
; Delphi 10.4
Root: HKCU; Subkey: "{code:GetDelphiRegKey|27}\Jedi\JVCL"; ValueType: string; ValueName: "BplDir"; ValueData: {code:GetDelphiBplDir|27}; Components: "IDE\Delphi27"; Flags: uninsdeletevalue;
Root: HKCU; Subkey: "{code:GetDelphiRegKey|27}\Jedi\JVCL"; ValueType: string; ValueName: "DcpDir"; ValueData: {app}\lib\d27; Components: "IDE\Delphi27"; Flags: uninsdeletevalue;
...
Root: HKCU; Subkey: "{code:GetDelphiRegKey|27}\Jedi\JVCL\IDE"; ValueType: dword; ValueName: "RegisterGlobalDesignEditors"; ValueData: 1; Components: "Options\RegisterGlobalDesignEditors"; Flags: uninsdeletevalue;
Root: HKCU; Subkey: "{code:GetDelphiRegKey|27}\Globals"; ValueType: string; ValueName: "ForceEnvOptionsUpdate"; ValueData: "1"; Components: "IDE\Delphi27";
#endif

#ifdef Include_Delphi28
; Delphi 11
Root: HKCU; Subkey: "{code:GetDelphiRegKey|28}\Jedi\JVCL"; ValueType: string; ValueName: "BplDir"; ValueData: {code:GetDelphiBplDir|28}; Components: "IDE\Delphi28"; Flags: uninsdeletevalue;
Root: HKCU; Subkey: "{code:GetDelphiRegKey|28}\Jedi\JVCL"; ValueType: string; ValueName: "DcpDir"; ValueData: {app}\lib\d28; Components: "IDE\Delphi28"; Flags: uninsdeletevalue;
Root: HKCU; Subkey: "{code:GetDelphiRegKey|28}\Jedi\JVCL"; ValueType: string; ValueName: "RootDir"; ValueData: {app}; Components: "IDE\Delphi28"; Flags: uninsdeletevalue;
Root: HKCU; Subkey: "{code:GetDelphiRegKey|28}\Jedi\JVCL"; ValueType: string; ValueName: "Version"; ValueData: {#JvclVersionStr}; Components: "IDE\Delphi28"; Flags: uninsdeletevalue;
Root: HKCU; Subkey: "{code:GetDelphiRegKey|28}\Jedi\JVCL\IDE"; ValueType: dword; ValueName: "RegisterGlobalDesignEditors"; ValueData: 1; Components: "Options\RegisterGlobalDesignEditors"; Flags: uninsdeletevalue;
Root: HKCU; Subkey: "{code:GetDelphiRegKey|28}\Globals"; ValueType: string; ValueName: "ForceEnvOptionsUpdate"; ValueData: "1"; Components: "IDE\Delphi28";
#endif

#ifdef Include_Delphi29
; Delphi 12
Root: HKCU; Subkey: "{code:GetDelphiRegKey|29}\Jedi\JVCL"; ValueType: string; ValueName: "BplDir"; ValueData: {code:GetDelphiBplDir|29}; Components: "IDE\Delphi29"; Flags: uninsdeletevalue;
Root: HKCU; Subkey: "{code:GetDelphiRegKey|29}\Jedi\JVCL"; ValueType: string; ValueName: "DcpDir"; ValueData: {app}\lib\d29; Components: "IDE\Delphi29"; Flags: uninsdeletevalue;
Root: HKCU; Subkey: "{code:GetDelphiRegKey|29}\Jedi\JVCL"; ValueType: string; ValueName: "RootDir"; ValueData: {app}; Components: "IDE\Delphi29"; Flags: uninsdeletevalue;
Root: HKCU; Subkey: "{code:GetDelphiRegKey|29}\Jedi\JVCL"; ValueType: string; ValueName: "Version"; ValueData: {#JvclVersionStr}; Components: "IDE\Delphi29"; Flags: uninsdeletevalue;
Root: HKCU; Subkey: "{code:GetDelphiRegKey|29}\Jedi\JVCL\IDE"; ValueType: dword; ValueName: "RegisterGlobalDesignEditors"; ValueData: 1; Components: "Options\RegisterGlobalDesignEditors"; Flags: uninsdeletevalue;
Root: HKCU; Subkey: "{code:GetDelphiRegKey|29}\Globals"; ValueType: string; ValueName: "ForceEnvOptionsUpdate"; ValueData: "1"; Components: "IDE\Delphi29";
#endif

#ifdef Include_Delphi37
; Delphi 13
Root: HKCU; Subkey: "{code:GetDelphiRegKey|37}\Jedi\JVCL"; ValueType: string; ValueName: "BplDir"; ValueData: {code:GetDelphiBplDir|37}; Components: "IDE\Delphi37"; Flags: uninsdeletevalue;
Root: HKCU; Subkey: "{code:GetDelphiRegKey|37}\Jedi\JVCL"; ValueType: string; ValueName: "DcpDir"; ValueData: {app}\lib\d37; Components: "IDE\Delphi37"; Flags: uninsdeletevalue;
Root: HKCU; Subkey: "{code:GetDelphiRegKey|37}\Jedi\JVCL"; ValueType: string; ValueName: "RootDir"; ValueData: {app}; Components: "IDE\Delphi37"; Flags: uninsdeletevalue;
Root: HKCU; Subkey: "{code:GetDelphiRegKey|37}\Jedi\JVCL"; ValueType: string; ValueName: "Version"; ValueData: {#JvclVersionStr}; Components: "IDE\Delphi37"; Flags: uninsdeletevalue;
Root: HKCU; Subkey: "{code:GetDelphiRegKey|37}\Jedi\JVCL\IDE"; ValueType: dword; ValueName: "RegisterGlobalDesignEditors"; ValueData: 1; Components: "Options\RegisterGlobalDesignEditors"; Flags: uninsdeletevalue;
Root: HKCU; Subkey: "{code:GetDelphiRegKey|37}\Globals"; ValueType: string; ValueName: "ForceEnvOptionsUpdate"; ValueData: "1"; Components: "IDE\Delphi37";
#endif
...
; lib\Delphi/C++Builder 10.4
Type: files; Name: "{app}\lib\d27\win32\*"
Type: files; Name: "{app}\lib\d27\win32\debug\*"
Type: files; Name: "{app}\lib\d27\win64\*"
Type: files; Name: "{app}\lib\d27\win64\debug\*"
Type: files; Name: "{app}\include\d27\*"
Type: files; Name: "{code:GetDelphiBplDir|27}\Jv*.*"
Type: files; Name: "{code:GetDelphiBplDir|27}\Win64\Jv*.*"
; lib\Delphi/C++Builder 11
Type: files; Name: "{app}\lib\d28\win32\*"
Type: files; Name: "{app}\lib\d28\win32\debug\*"
Type: files; Name: "{app}\lib\d28\win64\*"
Type: files; Name: "{app}\lib\d28\win64\debug\*"
Type: files; Name: "{app}\include\d28\*"
Type: files; Name: "{code:GetDelphiBplDir|28}\Jv*.*"
Type: files; Name: "{code:GetDelphiBplDir|28}\Win64\Jv*.*"
; lib\Delphi/C++Builder 12
Type: files; Name: "{app}\lib\d29\win32\*"
Type: files; Name: "{app}\lib\d29\win32\debug\*"
Type: files; Name: "{app}\lib\d29\win64\*"
Type: files; Name: "{app}\lib\d29\win64\debug\*"
Type: files; Name: "{app}\include\d29\*"
Type: files; Name: "{code:GetDelphiBplDir|29}\Jv*.*"
Type: files; Name: "{code:GetDelphiBplDir|29}\Win64\Jv*.*"
; lib\Delphi/C++Builder 13
Type: files; Name: "{app}\lib\d37\win32\*"
Type: files; Name: "{app}\lib\d37\win32\debug\*"
Type: files; Name: "{app}\lib\d37\win64\*"
Type: files; Name: "{app}\lib\d37\win64\debug\*"
Type: files; Name: "{app}\include\d37\*"
Type: files; Name: "{code:GetDelphiBplDir|37}\Jv*.*"
Type: files; Name: "{code:GetDelphiBplDir|37}\Win64\Jv*.*"
