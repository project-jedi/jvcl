...
* Run pg2want.bat from devtools\bin (build devtools\pg2want\pg2want.dpr first). This creates a new file, sep.xml.
* Insert the result from sep.xml into want.xml in the Release folder where it says "  <!-- !!!insert "separate" targets here!!! -->"
...
* Open a command prompt in Release and type "want separate" to build the single package zip files only
