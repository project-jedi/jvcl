...
{$ENDIF}
  ...
  RTLConsts, DesignIntf, DesignEditors, VCLEditors, JvPageMngr, StdCtrls, JvPlacemnt, ExtCtrls,
  JvVCLUtils, DesignWindows;
...
uses Consts, Buttons, JvCtrls, JvConst, JvLConst, JvDsgn;
...
procedure TJvProxyEditor.DesignerClosed(const Designer: IDesigner; AGoingDormant: Boolean);
begin
