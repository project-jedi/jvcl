...
initialization
  Screen.Cursors[crHand] := LoadCursor(hInstance, 'Jvx_HANDCUR');
  Screen.Cursors[crDragHand] := LoadCursor(hInstance, 'Jvx_DRAGCUR');
end.
