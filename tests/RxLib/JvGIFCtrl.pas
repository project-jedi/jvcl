...
{$ENDIF}
    property JvAnimate: Boolean read FAnimate write SetAnimate default False;
{$IFDEF Delphi4_Up}
...
procedure TJvGIFAnimator.SetImage(Value: TGIFImage);
begin
  Lock;
  try
    FImage.Assign(Value);
