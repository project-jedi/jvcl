object SpeedbarEditor: TJvxSpeedbarEditor
  Left = 222
  Top = 126
  ActiveControl = SectionList
  BorderIcons = [biSystemMenu, biMinimize]
  BorderStyle = bsDialog
  Caption = 'JvxSpeedbar Designer'
  ClientHeight = 277
  ClientWidth = 437
  Color = clBtnFace
  ...
  object LabelHint: TLabel
    ...
    AutoSize = False
    Caption = 
      'To add command buttons, drag and drop button onto the JvxSpeedbar. ' +
      'To remove command buttons, drag them off of the JvxSpeedbar.'
    WordWrap = True
  end
  ...
  object FormPlacement1: TJvxFormPlacement
