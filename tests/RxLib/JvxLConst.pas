...
The Original Code is: JvxLConst.PAS, released on 2002-07-04.
...
{ TJvxFormStorage component editor }

  srStorageDesigner    = MaxExtStrID - 4;

{ TJvxPageManager component editor }
...
{ TJvxMemoryTable & TJvxMemoryData component editor }
