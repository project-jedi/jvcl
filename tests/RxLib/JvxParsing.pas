...
The Original Code is: JvxParsing.PAS, released on 2002-07-04.
...
function TJvxMathParser.GetChar: Char;
begin
  Result := FParseText[FCurPos];
end;

procedure TJvxMathParser.NextChar;
begin
  Inc(FCurPos);
end;

function TJvxMathParser.GetNumber(var AValue: Extended): Boolean;
var
  C: Char;
  SavePos: Cardinal;
  Code: Integer;
...
function TJvxMathParser.GetConst(var AValue: Extended): Boolean;
begin
  Result := False;
...
function TJvxMathParser.GetUserFunction(var Index: Integer): Boolean;
var
  TmpStr: string;
  I: Integer;
begin
...
function TJvxMathParser.GetFunction(var AValue: TParserFunc): Boolean;
var
  I: TParserFunc;
  TmpStr: string;
begin
...
function TJvxMathParser.Term: Extended;
var
  Value: Extended;
  NoFunc: TParserFunc;
  UserFunc: Integer;
...
function TJvxMathParser.SubTerm: Extended;
var
  Value: Extended;
begin
  Value := Term;
...
function TJvxMathParser.Calculate: Extended;
var
  Value: Extended;
begin
  Value := SubTerm;
...
function TJvxMathParser.Exec(const AFormula: string): Extended;
var
  I, J: Integer;
begin
  J := 0;
...
class procedure TJvxMathParser.RegisterUserFunction(const Name: string;
  Proc: TUserFunction);
var
  I: Integer;
begin
...
class procedure TJvxMathParser.UnregisterUserFunction(const Name: string);
var
  I: Integer;
begin
