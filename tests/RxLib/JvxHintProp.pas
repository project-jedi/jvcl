...
The Original Code is: JvxHintProp.PAS, released on 2002-07-04.
...
uses SysUtils, Classes, {$IFDEF Delphi3_Up} JvxStrLEdit, {$ELSE} JvxStrEdit, {$ENDIF}
  TypInfo, Forms, Controls, JvxStrUtils;
