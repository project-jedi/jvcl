...
The Original Code is: JvxGradEdit.PAS, released on 2002-07-04.
...
uses
  ...
  StdCtrls, Mask, JvxToolEdit, JvxGrdCpt, RTLConsts, DesignIntf, DesignEditors, VCLEditors, JvxCtrls, JvxPlacemnt;
...
type
  ...
  private
    ...
    function GetActiveCaption: TJvxCaption;
    procedure ApplyChanges;
  public
    { Public declarations }
    procedure SetGradientCaption(Component: TJvxGradientCaption;
      Designer: IDesigner);
    property ActiveCaption: TJvxCaption read GetActiveCaption;
  end;
...
uses JvxVCLUtils, JvxBoxProcs, JvxConst, JvxLConst;
...
function TGradCaptionsEditor.GetActiveCaption: TJvxCaption;
var
  I: Integer;
begin
  Result := nil;
