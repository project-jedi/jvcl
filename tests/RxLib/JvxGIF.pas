...
The Original Code is: JvxGIF.PAS, released on 2002-07-04.
...
uses Windows, RTLConsts, SysUtils, Classes, Graphics, JvxGraph;
...
uses Consts, {$IFNDEF WIN32} JvxStr16, {$ENDIF} JvxVCLUtils, JvxAniFile, JvxConst,
  JvxMaxMin, JvxGConst;
