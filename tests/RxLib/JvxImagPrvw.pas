...
The Original Code is: JvxImagPrvw.PAS, released on 2002-07-04.
...
uses SysUtils, {$IFDEF WIN32} Windows, {$ELSE} WinTypes, WinProcs, {$ENDIF}
  ...
  JvxCtrls, JvxPicClip, JvxPlacemnt, ObjStr, JvxSpeedButton;
...
uses Consts, JvxMaxMin, JvxConst, JvxVCLUtils, JvxGraph;
...
begin
  if ValidPicture(Image.Picture) then begin
    with JvxGraph.ZoomImage(Image.Picture.Width, Image.Picture.Height,
