...
uses SysUtils, {$IFDEF WIN32} Windows, {$ELSE} WinTypes, WinProcs, {$ENDIF}
  ...
  Buttons, Mask, JvCurrEdit, JvVCLUtils, JvPlacemnt, RTLConsts, DesignIntf, DesignEditors, VCLEditors, Consts;
...
type
  TMinMaxInfoEditDialog = class(TForm)
    ...
    MaxPosLeftEdit: TJvCurrencyEdit;
    MaxPosTopEdit: TJvCurrencyEdit;
    MaxSizeWidthEdit: TJvCurrencyEdit;
    MaxSizeHeightEdit: TJvCurrencyEdit;
    MaxTrackWidthEdit: TJvCurrencyEdit;
    MaxTrackHeightEdit: TJvCurrencyEdit;
    MinTrackWidthEdit: TJvCurrencyEdit;
    MinTrackHeightEdit: TJvCurrencyEdit;
    ClearBtn: TButton;
