...
The Original Code is: JvxOle2Auto.PAS, released on 2002-07-04.
...
{ OLE2 Automation Controller }
  ...
  TJvxOleController = class(TObject)
  private
    FLocale: TLCID;
    FObject: Variant;
    FRetValue: Variant;
...
constructor TJvxOleController.Create;
begin
  inherited Create;
{$IFDEF WIN32}
...
destructor TJvxOleController.Destroy;
begin
  if FOleInitialized then ClearObject;
  inherited Destroy;
end;

procedure TJvxOleController.CreateObject(const ClassName: string);
begin
  CheckOleInitialized;
  ClearObject;
...
procedure TJvxOleController.GetActiveObject(const ClassName: string);
begin
  CheckOleInitialized;
  ClearObject;
...
procedure TJvxOleController.AssignIDispatch(V: Variant);
begin
  CheckOleInitialized;
  ClearObject;
  VarToInterface(V);
...
procedure TJvxOleController.ClearObject;
begin
{$IFDEF WIN32}
  VarClear(FRetValue);
  VarClear(FObject);
...
function TJvxOleController.NameToDispID(const AName: string): TDispID;
var
{$IFDEF WIN32}
...
function TJvxOleController.NameToDispIDs(const AName: string;
  const AParams: array of string; Dest: PDispIDList): PDispIDList;
var
{$IFDEF WIN32}
...
function TJvxOleController.Invoke(dispidMember: TDispID; wFlags: Word;
  var pdispparams: TDispParams; Res: PVariant): PVariant;
var
...
function TJvxOleController.CallMethodNoParams(ID: TDispID;
  NeedResult: Boolean): PVariant;
const
...
function TJvxOleController.CallMethod(ID: TDispID; const Params: array of const;
  NeedResult: Boolean): PVariant;
var
  Disp: TDispParams;
  ArgCnt, I: Integer;
...
function TJvxOleController.CallMethodNamedParams(const IDs: TDispIDList;
  const Params: array of const; Cnt: Byte; NeedResult: Boolean): PVariant;
var
  Disp: TDispParams;
  ArgCnt, I: Integer;
...
procedure TJvxOleController.SetPropertyByID(ID: TDispID; const Prop: array of const);
const
...
function TJvxOleController.GetPropertyByID(ID: TDispID): PVariant;
const
...
procedure TJvxOleController.CallProcedureByID(ID: TDispID; const Params: array of const);
begin
  CallMethod(ID, Params, False);
end;

function TJvxOleController.CallFunctionByID(ID: TDispID;
  const Params: array of const): PVariant;
begin
  Result := CallMethod(ID, Params, True);
end;

procedure TJvxOleController.CallProcedureByIDsNamedParams(const IDs: TDispIDList;
  const Params: array of const; Cnt: Byte);
begin
  CallMethodNamedParams(IDs, Params, Cnt, False);
end;

function TJvxOleController.CallFunctionByIDsNamedParams(const IDs: TDispIDList;
  const Params: array of const; Cnt: Byte): PVariant;
begin
  Result := CallMethodNamedParams(IDs, Params, Cnt, True);
end;

procedure TJvxOleController.CallProcedureNoParamsByID(ID: TDispID);
begin
  CallMethodNoParams(ID, False);
end;

function TJvxOleController.CallFunctionNoParamsByID(ID: TDispID): PVariant;
begin
  Result := CallMethodNoParams(ID, True);
end;

procedure TJvxOleController.SetProperty(const AName: string;
  const Prop: array of const);
begin
  SetPropertyByID(NameToDispID(AName), Prop);
end;

function TJvxOleController.GetProperty(const AName: string): PVariant;
begin
  Result := GetPropertyByID(NameToDispID(AName));
end;

procedure TJvxOleController.CallProcedure(const AName: string;
  const Params: array of const);
begin
  CallProcedureByID(NameToDispID(AName), Params);
end;

function TJvxOleController.CallFunction(const AName: string;
  const Params: array of const): PVariant;
begin
  Result := CallFunctionByID(NameToDispID(AName), Params);
end;

procedure TJvxOleController.CallProcedureNamedParams(const AName: string;
...
function TJvxOleController.CallFunctionNamedParams(const AName: string;
...
procedure TJvxOleController.CallProcedureNoParams(const AName: string);
begin
  CallProcedureNoParamsByID(NameToDispID(AName));
end;

function TJvxOleController.CallFunctionNoParams(const AName: string): PVariant;
begin
  Result := CallFunctionNoParamsByID(NameToDispID(AName));
end;

procedure TJvxOleController.SetLocale(PrimaryLangID, SubLangID: Word);
begin
