...
The Original Code is: JvxDirFrm.PAS, released on 2002-07-04.
...
type
  TJvxDirectoryListDialog = class(TForm)
    DirectoryList: TJvxTextListBox;
    AddBtn: TButton;
    RemoveBtn: TButton;
    ModifyBtn: TButton;
    OKBtn: TButton;
...
uses JvxFileUtil, JvxBoxProcs, JvxConst;

{$R *.DFM}

function EditFolderList(Folders: TStrings): Boolean;
begin
  with TJvxDirectoryListDialog.Create(Application) do
  try
...
{ TJvxDirectoryListDialog }

procedure TJvxDirectoryListDialog.CheckButtons;
begin
...
procedure TJvxDirectoryListDialog.AddBtnClick(Sender: TObject);
var
  I: Integer;
  S: string;
begin
...
procedure TJvxDirectoryListDialog.ModifyBtnClick(Sender: TObject);
var
  I: Integer;
  S: string;
begin
...
procedure TJvxDirectoryListDialog.RemoveBtnClick(Sender: TObject);
var
  I: Integer;
begin
  I := DirectoryList.ItemIndex;
...
procedure TJvxDirectoryListDialog.DirectoryListClick(Sender: TObject);
begin
  CheckButtons;
end;

procedure TJvxDirectoryListDialog.FormShow(Sender: TObject);
begin
  CheckButtons;
end;

procedure TJvxDirectoryListDialog.DirectoryListDragDrop(Sender,
...
procedure TJvxDirectoryListDialog.DirectoryListDragOver(Sender,
...
procedure TJvxDirectoryListDialog.FormCreate(Sender: TObject);
begin
{$IFDEF WIN32}
