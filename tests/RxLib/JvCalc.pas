...
uses Windows, SysUtils, Variants,
  ...
  ExtCtrls, Buttons, JvCtrls, Clipbrd{, JvComponent};
...
uses {$IFNDEF WIN32} JvStr16, {$ENDIF} JvVCLUtils, JvMaxMin, JvStrUtils, JvToolEdit;
...
begin
  ...
  if BtnTag >= 0 then
    for I := 0 to ControlCount - 1 do begin
      if Controls[I] is TJvSpeedButton then begin
