...
begin
 ...
 with canvas do begin
  ...
  else if (isthisyear and (arow=thismonth)and (s=thisdaystr)) then begin
...
begin
 alist.clear;
 if border then tbs:='1' else tbs:='0';
...
begin
 ...
 for arow:=0 to 12 do begin
  for acol:=0 to 37 do begin
    ...
    if YearData[acol,arow].Custom then s:='true' else s:='false';
    Dlist.append(s);
...
begin
  if value<>FBookMarkColor then begin
