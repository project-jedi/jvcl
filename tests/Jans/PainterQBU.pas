...
uses
  ...
  StdCtrls, ExtCtrls, Menus, ComCtrls, janDrawImage;
...
begin
if qbpresets.itemindex>=0 then begin
...
var s:string;
    p:integer;
begin
if not(qbpresets.ItemIndex>=0) then begin
...
procedure TPainterQBF.setDrawImage(aDrawImage: TjandrawImage);
begin
  PainterF:=aDrawImage;
end;
