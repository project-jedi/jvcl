...
The Original Code is: jvShappedButton.PAS, released on 2002-11-12.
...
type
  ...
  TjvShappedButton = class(TButton)
  private
    bm:TBitmap;
    IsFocused: Boolean;
    IsHot:boolean;
...
constructor TjvShappedButton.Create (AOwner: TComponent);
begin
...
destructor TjvShappedButton.Destroy;
begin
  inherited Destroy;
  bm.free;
  FCanvas.Free;
...
procedure TjvShappedButton.CreateParams(var Params: TCreateParams);
begin
...
procedure TjvShappedButton.CreateWnd;
begin
  inherited CreateWnd;
...
procedure TjvShappedButton.SetBounds (ALeft, ATop,
...
procedure TjvShappedButton.CNDrawItem(var Msg: TWMDrawItem);
begin
  case FButtonShape of
...
procedure TjvShappedButton.CMFontChanged(var Msg: TMessage);
begin
  inherited;
  Invalidate;
end;

procedure TjvShappedButton.CMEnabledChanged(var Msg: TMessage);
begin
  inherited;
  Invalidate;
end;

procedure TjvShappedButton.WMLButtonDblClk(var Message: TWMLButtonDblClk);
begin
  Perform(WM_LBUTTONDOWN, Message.Keys, Longint(Message.Pos));
end;

procedure TjvShappedButton.SetButtonStyle (ADefault: Boolean);
begin
...
procedure TjvShappedButton.CMMouseEnter(var Message: TMessage);
begin
  IsHot:=true;
  invalidate;
end;

procedure TjvShappedButton.CMMouseLeave(var Message: TMessage);
begin
  IsHot:=false;
  invalidate;
end;

procedure TjvShappedButton.SetHotColor(const Value: TColor);
begin
  FHotColor := Value;
end;

procedure TjvShappedButton.SetFlat(const Value: boolean);
begin
  FFlat := Value;
  invalidate;
end;

procedure TjvShappedButton.SetFlatBorderColor(const Value: TColor);
begin
  FFlatBorderColor := Value;
end;


procedure TjvShappedButton.SetButtonShape(const Value: TjvButtonShapes);
begin
...
procedure TjvShappedButton.SetRegionOctagon(ALeft, ATop, AWidth, AHeight: Integer);
var
 x4,y4 : Integer;
 hRegion: THandle;
...
procedure TjvShappedButton.CNDrawItemOctagon(var Msg: TWMDrawItem);
var
...
procedure TjvShappedButton.SetRegionTriangleDown(ALeft, ATop, AWidth, AHeight: Integer);
var
 x2 : Integer;
 hRegion: THandle;
...
procedure TjvShappedButton.SetRegionTriangleLeft(ALeft, ATop, AWidth, AHeight: Integer);
var
 y2 : Integer;
 hRegion: THandle;
 poly: array[0..2] of Tpoint;
...
procedure TjvShappedButton.SetRegionTriangleRight(ALeft, ATop, AWidth, AHeight: Integer);
var
 y2 : Integer;
 hRegion: THandle;
 poly: array[0..2] of Tpoint;
...
procedure TjvShappedButton.SetRegionTriangleUp(ALeft, ATop, AWidth, AHeight: Integer);
var
 x2 : Integer;
 hRegion: THandle;
 poly: array[0..2] of Tpoint;
...
procedure TjvShappedButton.CNDrawItemTriangleRight(var Msg: TWMDrawItem);
var
  OdsDown, OdsFocus, ActionFocus: Boolean;
  Rect: TRect;
...
procedure TjvShappedButton.CNDrawItemTriangleUp(var Msg: TWMDrawItem);
var
  OdsDown, OdsFocus, ActionFocus: Boolean;
  Rect: TRect;
  poly: array[0..3] of Tpoint;
...
procedure TjvShappedButton.CNDrawItemTriangleLeft(var Msg: TWMDrawItem);
var
  OdsDown, OdsFocus, ActionFocus: Boolean;
  Rect: TRect;
  poly: array[0..3] of Tpoint;
...
procedure TjvShappedButton.CNDrawItemTriangleDown(var Msg: TWMDrawItem);
var
  OdsDown, OdsFocus, ActionFocus: Boolean;
  Rect: TRect;
  poly: array[0..3] of Tpoint;
...
procedure TjvShappedButton.CNDrawItemPar(var Msg: TWMDrawItem);
var
  OdsDown, OdsFocus, ActionFocus: Boolean;
  Rect: TRect;
...
procedure TjvShappedButton.SetRegionPar(ALeft, ATop, AWidth, AHeight: Integer);
var
  hRegion: THandle;
  poly: array[0..3] of Tpoint;
  x4:integer;
...
procedure TjvShappedButton.SetRegionDiamond(ALeft, ATop, AWidth,
  AHeight: Integer);
var
  hRegion: THandle;
  poly: array[0..3] of Tpoint;
...
procedure TjvShappedButton.SetRegionHex(ALeft, ATop, AWidth,
  AHeight: Integer);
var
  hRegion: THandle;
...
procedure TjvShappedButton.SetRegionLeftArrow(ALeft, ATop, AWidth,
  AHeight: Integer);
var
  hRegion: THandle;
  poly: array[0..5] of Tpoint;
...
procedure TjvShappedButton.SetRegionPentagon(ALeft, ATop, AWidth,
  AHeight: Integer);
var
  hRegion: THandle;
  poly: array[0..4] of Tpoint;
...
procedure TjvShappedButton.SetRegionRevPentagon(ALeft, ATop, AWidth,
  AHeight: Integer);
var
  hRegion: THandle;
  poly: array[0..4] of Tpoint;
...
procedure TjvShappedButton.SetRegionRightArrow(ALeft, ATop, AWidth,
  AHeight: Integer);
var
  hRegion: THandle;
  poly: array[0..5] of Tpoint;
...
procedure TjvShappedButton.SetRegionRing(ALeft, ATop, AWidth,
  AHeight: Integer);
var
  rgn1,rgn2,rgn3: Hrgn;
  x4,y4:integer;
...
procedure TjvShappedButton.SetRegionRound(ALeft, ATop, AWidth,
  AHeight: Integer);
var
  hRegion: THandle;
begin
...
procedure TjvShappedButton.calcpentagon(AWidth, Aheight: integer);
var
  x2,y2,r:integer;
  a:extended;
begin
...
procedure TjvShappedButton.SetFlatArrow(const Value: boolean);
begin
...
procedure TjvShappedButton.CNDrawItemLeftArrow(var Msg: TWMDrawItem);
var
  OdsDown, OdsFocus, ActionFocus: Boolean;
  Rect: TRect;
...
procedure TjvShappedButton.CNDrawItemRightArrow(var Msg: TWMDrawItem);
var
  OdsDown, OdsFocus, ActionFocus: Boolean;
  Rect: TRect;
  poly: array[0..6] of Tpoint;
...
procedure TjvShappedButton.CNDrawItemRing(var Msg: TWMDrawItem);
var
  OdsDown, OdsFocus, ActionFocus: Boolean;
  R,Ri: TRect;
  x4,y4:integer;
...
procedure TjvShappedButton.CNDrawItemRound(var Msg: TWMDrawItem);
var
  OdsDown, OdsFocus, ActionFocus: Boolean;
  Rect: TRect;
begin
...
procedure TjvShappedButton.CNDrawItemPentagon(var Msg: TWMDrawItem);
var
  OdsDown, OdsFocus, ActionFocus: Boolean;
  Rect: TRect;
  poly: array[0..5] of Tpoint;
...
procedure TjvShappedButton.CNDrawItemRevPentagon(var Msg: TWMDrawItem);
var
  OdsDown, OdsFocus, ActionFocus: Boolean;
  Rect: TRect;
  poly: array[0..5] of Tpoint;
...
procedure TjvShappedButton.CNDrawItemHex(var Msg: TWMDrawItem);
var
  OdsDown, OdsFocus, ActionFocus: Boolean;
  Rect: TRect;
  poly: array[0..6] of Tpoint;
...
procedure TjvShappedButton.CNDrawItemDiamond(var Msg: TWMDrawItem);
var
  OdsDown, OdsFocus, ActionFocus: Boolean;
  Rect: TRect;
  poly: array[0..4] of Tpoint;
