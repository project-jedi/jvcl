...
uses
  ...
  Dialogs, JvShellHook, StdCtrls, ComCtrls;
...
begin
  SH := TJvShellHookComponent.Create(self);
...
procedure TfrmMain.DoShellMessage(Sender: TObject; var Message: TMessage);
var S: string;
begin
  with Message do
  begin
    case wParam of
      ...
      begin
        ...
        if lParam = Application.Handle then
          S := S + ' (this)';
      end;
...
procedure TfrmMain.lvMessagesResize(Sender: TObject);
begin
