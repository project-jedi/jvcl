...
var
  JvLogFileDemo: TJvLogFileDemo;

implementation

{$R *.dfm}

procedure TJvLogFileDemo.btnStartClick(Sender: TObject);
begin
...
procedure TJvLogFileDemo.btnShowClick(Sender: TObject);
begin
...
procedure TJvLogFileDemo.FormMouseMove(Sender: TObject; Shift: TShiftState; X,
  Y: Integer);
begin
  if btnStart.Tag = 1 then
...
procedure TJvLogFileDemo.ResetLogging;
begin
  StopLogging;
...
procedure TJvLogFileDemo.StartLogging;
begin
...
procedure TJvLogFileDemo.StopLogging;
begin
  btnStart.Tag := 0;
...
procedure TJvLogFileDemo.btnResetClick(Sender: TObject);
begin
  ResetLogging;
end;
