...
procedure TJvOutlookBarForm.DoPageChange(Sender:TObject;Index:integer);
begin
  if Index > -1 then
    Caption := Format('Page changed to "%s"',[OL.Pages[Index].Caption]);
end;

procedure TJvOutlookBarForm.DoPageChanging(Sender:TObject;Index:integer;var AllowChange:boolean);
begin
...
procedure TJvOutlookBarForm.DoButtonClick(Sender:TObject; Index:integer);
...
procedure TJvOutlookBarForm.OLContextPopUp(Sender: TObject; MousePos: TPoint; var Handled: Boolean);
begin
...
procedure TJvOutlookBarForm.FormCreate(Sender: TObject);
begin
...
procedure TJvOutlookBarForm.Editpagecaption1Click(Sender: TObject);
begin
  with OL.PopUpObject as TJvOutlookBarPage do
    EditCaption;
end;

procedure TJvOutlookBarForm.Editbuttoncaption1Click(Sender: TObject);
begin
  with OL.PopUpObject as TJvOutlookBarButton do
    EditCaption;
end;

procedure TJvOutlookBarForm.Button1Click(Sender: TObject);
begin
  OL.LargeImages := ImageList1;
  OL.SmallImages := ImageList2;
end;

procedure TJvOutlookBarForm.Button2Click(Sender: TObject);
begin
  OL.LargeImages := nil;
  OL.SmallImages := nil;
end;

procedure TJvOutlookBarForm.Button3Click(Sender: TObject);
var i:integer;
begin
