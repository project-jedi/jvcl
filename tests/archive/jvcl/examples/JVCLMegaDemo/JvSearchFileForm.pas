...
type
  TJvSeachFilesForm = class(TForm)
    ...
    procedure JvSearchFile1BeginScanDir(Sender: TObject; const AName: String);
...
var
  JvSeachFilesForm: TJvSeachFilesForm;
...
procedure TJvSeachFilesForm.btnSearchClick(Sender: TObject);
begin
...
procedure TJvSeachFilesForm.JvSearchFile1FindFile(Sender: TObject;
  const AName: string);
begin
...
procedure TJvSeachFilesForm.btnCancelClick(Sender: TObject);
begin
  JvSearchFile1.Abort;
  btnCancel.Enabled := false;
end;

procedure TJvSeachFilesForm.FormCloseQuery(Sender: TObject; var CanClose: Boolean);
begin
  btnCancel.Click;
end;

procedure TJvSeachFilesForm.FormCreate(Sender: TObject);
begin
  JvFormStorage1.IniFileName := ChangeFileExt(Application.ExeName,'.ini');
end;

procedure TJvSeachFilesForm.JvSearchFile1BeginScanDir(Sender: TObject;
  const AName: String);
begin
...
procedure TJvSeachFilesForm.OptionsChange(Sender: TObject);
begin
...
procedure TJvSeachFilesForm.Sort1Click(Sender: TObject);
var S:TStringlist;
begin
...
procedure TJvSeachFilesForm.Clear1Click(Sender: TObject);
begin
  reFoundFiles.Clear;
end;

procedure TJvSeachFilesForm.AddSearchTextToComboBox;
begin
