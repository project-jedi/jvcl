...
var
  JvListCombForm: TJvListCombForm;

implementation

{$R *.DFM}

procedure TJvListCombForm.TransparentButton1Click(Sender: TObject);
begin
  ShowMessage('Hej Simon!')
end;

procedure TJvListCombForm.Button1Click(Sender: TObject);
...
procedure TJvListCombForm.Button2Click(Sender: TObject);
begin
...
procedure TJvListCombForm.CheckBox1Click(Sender: TObject);
begin
