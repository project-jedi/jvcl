...
var
  JvNTEventLogForm: TJvNTEventLogForm;

implementation

{$R *.dfm}

procedure TJvNTEventLogForm.FormCreate(Sender: TObject);
begin
  JvNTEventLog1.ReadEventLogs(ListBox1.Items);
  JvNTEventLog1.Active := True;
end;

procedure TJvNTEventLogForm.ListBox1Click(Sender: TObject);
begin
...
procedure TJvNTEventLogForm.ReadEvents;
var
  item: TListItem;
begin
