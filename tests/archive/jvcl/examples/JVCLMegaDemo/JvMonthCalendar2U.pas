...
type
  TJvMonthCalendar2Form = class(TForm)
...
procedure TJvMonthCalendar2Form.mcSelChange(Sender: TObject; StartDate,
  EndDate: TDateTime);
begin
...
procedure TJvMonthCalendar2Form.mcSelect(Sender: TObject; StartDate,
  EndDate: TDateTime);
var
  Y,M,D:Word;
begin
...
procedure TJvMonthCalendar2Form.chkMultiClick(Sender: TObject);
begin
  mc.MultiSelect := chkMulti.Checked;
end;

procedure TJvMonthCalendar2Form.chkShowClick(Sender: TObject);
begin
  mc.ShowToday := chkShow.Checked;
end;

procedure TJvMonthCalendar2Form.chkCircleClick(Sender: TObject);
begin
  mc.CircleToday := chkCircle.Checked;
end;

procedure TJvMonthCalendar2Form.chkWeeksClick(Sender: TObject);
begin
  mc.WeekNumbers := chkWeeks.Checked;
end;

procedure TJvMonthCalendar2Form.FormShow(Sender: TObject);
var Y,M,D:word;
begin
  mc.Today := Date;
