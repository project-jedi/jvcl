...
procedure TJvColorCombo.FormCreate(Sender: TObject);
begin
...
procedure TJvColorCombo.btnColorNamesClick(Sender: TObject);
begin
  memInfo.Lines := JvColorComboBox1.ColorNameMap;
end;

procedure TJvColorCombo.JvColorComboBox1NewColor(Sender: TObject; Color: TColor;
  var DisplayName: string; var AllowAdd: Boolean);
begin
...
procedure TJvColorCombo.LoadSettings;
var CurColor: TColor;
  S: string;
  SL: TStringlist;
  i: integer;
...
procedure TJvColorCombo.SaveSettings;
...
procedure TJvColorCombo.FormCloseQuery(Sender: TObject; var CanClose: Boolean);
begin
  SaveSettings;
end;

procedure TJvColorCombo.btnCustColorsClick(Sender: TObject);
...
procedure TJvColorCombo.cbDisplayStyleChange(Sender: TObject);
