...
procedure TfrmMain.btnColorNamesClick(Sender: TObject);
begin
...
procedure TfrmMain.btnCustColorsClick(Sender: TObject);
...
procedure TfrmMain.cbDisplayStyleChange(Sender: TObject);
