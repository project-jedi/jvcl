...
begin
  ...
  begin
   { TDBEdit }
    ...
    AddGet(TDBEdit, 'Field', TDBEdit_Read_Field, 0, [0], varEmpty);
    AddGet(TDBEdit, 'DataField', TDBEdit_Read_DataField, 0, [0], varEmpty);
    AddSet(TDBEdit, 'DataField', TDBEdit_Write_DataField, 0, [0]);
    AddGet(TDBEdit, 'DataSource', TDBEdit_Read_DataSource, 0, [0], varEmpty);
    AddSet(TDBEdit, 'DataSource', TDBEdit_Write_DataSource, 0, [0]);
    AddGet(TDBEdit, 'ReadOnly', TDBEdit_Read_ReadOnly, 0, [0], varEmpty);
   ...
   { TDBText }
    ...
    AddGet(TDBText, 'Field', TDBText_Read_Field, 0, [0], varEmpty);
    AddGet(TDBText, 'DataField', TDBText_Read_DataField, 0, [0], varEmpty);
    AddSet(TDBText, 'DataField', TDBText_Write_DataField, 0, [0]);
    AddGet(TDBText, 'DataSource', TDBText_Read_DataSource, 0, [0], varEmpty);
   ...
   { TDBCheckBox }
    ...
    AddGet(TDBCheckBox, 'Field', TDBCheckBox_Read_Field, 0, [0], varEmpty);
    AddGet(TDBCheckBox, 'DataField', TDBCheckBox_Read_DataField, 0, [0], varEmpty);
    AddSet(TDBCheckBox, 'DataField', TDBCheckBox_Write_DataField, 0, [0]);
    AddGet(TDBCheckBox, 'DataSource', TDBCheckBox_Read_DataSource, 0, [0], varEmpty);
    AddSet(TDBCheckBox, 'DataSource', TDBCheckBox_Write_DataSource, 0, [0]);
    AddGet(TDBCheckBox, 'ReadOnly', TDBCheckBox_Read_ReadOnly, 0, [0], varEmpty);
    AddSet(TDBCheckBox, 'ReadOnly', TDBCheckBox_Write_ReadOnly, 0, [0]);
    AddGet(TDBCheckBox, 'ValueChecked', TDBCheckBox_Read_ValueChecked, 0, [0], varEmpty);
    AddSet(TDBCheckBox, 'ValueChecked', TDBCheckBox_Write_ValueChecked, 0, [0]);
    AddGet(TDBCheckBox, 'ValueUnchecked', TDBCheckBox_Read_ValueUnchecked, 0, [0], varEmpty);
   ...
   { TDBComboBox }
    ...
    AddGet(TDBComboBox, 'Field', TDBComboBox_Read_Field, 0, [0], varEmpty);
    AddGet(TDBComboBox, 'DataField', TDBComboBox_Read_DataField, 0, [0], varEmpty);
    AddSet(TDBComboBox, 'DataField', TDBComboBox_Write_DataField, 0, [0]);
    AddGet(TDBComboBox, 'DataSource', TDBComboBox_Read_DataSource, 0, [0], varEmpty);
    AddSet(TDBComboBox, 'DataSource', TDBComboBox_Write_DataSource, 0, [0]);
    AddGet(TDBComboBox, 'ReadOnly', TDBComboBox_Read_ReadOnly, 0, [0], varEmpty);
   ...
   { TDBListBox }
    ...
    AddGet(TDBListBox, 'Field', TDBListBox_Read_Field, 0, [0], varEmpty);
    AddGet(TDBListBox, 'DataField', TDBListBox_Read_DataField, 0, [0], varEmpty);
    AddSet(TDBListBox, 'DataField', TDBListBox_Write_DataField, 0, [0]);
    AddGet(TDBListBox, 'DataSource', TDBListBox_Read_DataSource, 0, [0], varEmpty);
    AddSet(TDBListBox, 'DataSource', TDBListBox_Write_DataSource, 0, [0]);
    AddGet(TDBListBox, 'ReadOnly', TDBListBox_Read_ReadOnly, 0, [0], varEmpty);
   ...
   { TDBRadioGroup }
    ...
    AddGet(TDBRadioGroup, 'Field', TDBRadioGroup_Read_Field, 0, [0], varEmpty);
    AddGet(TDBRadioGroup, 'Value', TDBRadioGroup_Read_Value, 0, [0], varEmpty);
    AddSet(TDBRadioGroup, 'Value', TDBRadioGroup_Write_Value, 0, [0]);
    AddGet(TDBRadioGroup, 'DataField', TDBRadioGroup_Read_DataField, 0, [0], varEmpty);
    AddSet(TDBRadioGroup, 'DataField', TDBRadioGroup_Write_DataField, 0, [0]);
    AddGet(TDBRadioGroup, 'DataSource', TDBRadioGroup_Read_DataSource, 0, [0], varEmpty);
    AddSet(TDBRadioGroup, 'DataSource', TDBRadioGroup_Write_DataSource, 0, [0]);
    AddGet(TDBRadioGroup, 'ReadOnly', TDBRadioGroup_Read_ReadOnly, 0, [0], varEmpty);
    AddSet(TDBRadioGroup, 'ReadOnly', TDBRadioGroup_Write_ReadOnly, 0, [0]);
    AddGet(TDBRadioGroup, 'Values', TDBRadioGroup_Read_Values, 0, [0], varEmpty);
   ...
   { TDBMemo }
    ...
    AddGet(TDBMemo, 'LoadMemo', TDBMemo_LoadMemo, 0, [0], varEmpty);
    AddGet(TDBMemo, 'Field', TDBMemo_Read_Field, 0, [0], varEmpty);
    AddGet(TDBMemo, 'AutoDisplay', TDBMemo_Read_AutoDisplay, 0, [0], varEmpty);
    AddSet(TDBMemo, 'AutoDisplay', TDBMemo_Write_AutoDisplay, 0, [0]);
    AddGet(TDBMemo, 'DataField', TDBMemo_Read_DataField, 0, [0], varEmpty);
    AddSet(TDBMemo, 'DataField', TDBMemo_Write_DataField, 0, [0]);
    AddGet(TDBMemo, 'DataSource', TDBMemo_Read_DataSource, 0, [0], varEmpty);
    AddSet(TDBMemo, 'DataSource', TDBMemo_Write_DataSource, 0, [0]);
    AddGet(TDBMemo, 'ReadOnly', TDBMemo_Read_ReadOnly, 0, [0], varEmpty);
   ...
   { TDBImage }
    ...
    AddGet(TDBImage, 'CopyToClipboard', TDBImage_CopyToClipboard, 0, [0], varEmpty);
    AddGet(TDBImage, 'CutToClipboard', TDBImage_CutToClipboard, 0, [0], varEmpty);
    AddGet(TDBImage, 'LoadPicture', TDBImage_LoadPicture, 0, [0], varEmpty);
    AddGet(TDBImage, 'PasteFromClipboard', TDBImage_PasteFromClipboard, 0, [0], varEmpty);
    AddGet(TDBImage, 'Field', TDBImage_Read_Field, 0, [0], varEmpty);
    AddGet(TDBImage, 'Picture', TDBImage_Read_Picture, 0, [0], varEmpty);
    AddSet(TDBImage, 'Picture', TDBImage_Write_Picture, 0, [0]);
    AddGet(TDBImage, 'AutoDisplay', TDBImage_Read_AutoDisplay, 0, [0], varEmpty);
    AddSet(TDBImage, 'AutoDisplay', TDBImage_Write_AutoDisplay, 0, [0]);
    AddGet(TDBImage, 'BorderStyle', TDBImage_Read_BorderStyle, 0, [0], varEmpty);
    AddSet(TDBImage, 'BorderStyle', TDBImage_Write_BorderStyle, 0, [0]);
    AddGet(TDBImage, 'Center', TDBImage_Read_Center, 0, [0], varEmpty);
    AddSet(TDBImage, 'Center', TDBImage_Write_Center, 0, [0]);
    AddGet(TDBImage, 'DataField', TDBImage_Read_DataField, 0, [0], varEmpty);
    AddSet(TDBImage, 'DataField', TDBImage_Write_DataField, 0, [0]);
    AddGet(TDBImage, 'DataSource', TDBImage_Read_DataSource, 0, [0], varEmpty);
    AddSet(TDBImage, 'DataSource', TDBImage_Write_DataSource, 0, [0]);
    AddGet(TDBImage, 'ReadOnly', TDBImage_Read_ReadOnly, 0, [0], varEmpty);
    AddSet(TDBImage, 'ReadOnly', TDBImage_Write_ReadOnly, 0, [0]);
    AddGet(TDBImage, 'QuickDraw', TDBImage_Read_QuickDraw, 0, [0], varEmpty);
    AddSet(TDBImage, 'QuickDraw', TDBImage_Write_QuickDraw, 0, [0]);
    AddGet(TDBImage, 'Stretch', TDBImage_Read_Stretch, 0, [0], varEmpty);
   ...
   { TDBNavigator }
    ...
    AddGet(TDBNavigator, 'DataSource', TDBNavigator_Read_DataSource, 0, [0], varEmpty);
   ...
   { TDBLookupComboBox }
    ...
    AddGet(TDBLookupComboBox, 'DropDown', TDBLookupComboBox_DropDown, 0, [0], varEmpty);
    AddGet(TDBLookupComboBox, 'ListVisible', TDBLookupComboBox_Read_ListVisible, 0, [0], varEmpty);
    AddGet(TDBLookupComboBox, 'Text', TDBLookupComboBox_Read_Text, 0, [0], varEmpty);
    AddGet(TDBLookupComboBox, 'DropDownAlign', TDBLookupComboBox_Read_DropDownAlign, 0, [0], varEmpty);
    AddSet(TDBLookupComboBox, 'DropDownAlign', TDBLookupComboBox_Write_DropDownAlign, 0, [0]);
    AddGet(TDBLookupComboBox, 'DropDownRows', TDBLookupComboBox_Read_DropDownRows, 0, [0], varEmpty);
   ...
   { TDBRichEdit }
    ...
    AddGet(TDBRichEdit, 'LoadMemo', TDBRichEdit_LoadMemo, 0, [0], varEmpty);
    AddGet(TDBRichEdit, 'Field', TDBRichEdit_Read_Field, 0, [0], varEmpty);
    AddGet(TDBRichEdit, 'AutoDisplay', TDBRichEdit_Read_AutoDisplay, 0, [0], varEmpty);
    AddSet(TDBRichEdit, 'AutoDisplay', TDBRichEdit_Write_AutoDisplay, 0, [0]);
    AddGet(TDBRichEdit, 'DataField', TDBRichEdit_Read_DataField, 0, [0], varEmpty);
    AddSet(TDBRichEdit, 'DataField', TDBRichEdit_Write_DataField, 0, [0]);
    AddGet(TDBRichEdit, 'DataSource', TDBRichEdit_Read_DataSource, 0, [0], varEmpty);
