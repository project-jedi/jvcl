...
uses Windows, ExptIntf, EditIntf,
...
begin
  if PlugType = 0 then
    Result := GetCurrentDir + '\plg' + PlugName + '.dpr'
  else
    Result := GetCurrentDir + '\plg' + PlugName + '.dpk';
end;
...
begin
  //  Result := '';
  Result := GetCurrentDir + '\Plugin' + PlugName + '.pas'
end;
