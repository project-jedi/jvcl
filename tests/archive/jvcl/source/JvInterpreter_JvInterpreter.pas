...
procedure EJvInterpreterError_Create(var Value: Variant; Args: TArgs);
begin
  Value := O2V(EJvInterpreterError.Create(Args.Values[0], Args.Values[1], Args.Values[2], Args.Values[3]));
end;

{  procedure Assign(E: Exception); }
procedure EJvInterpreterError_Assign(var Value: Variant; Args: TArgs);
begin
  EJvInterpreterError(Args.Obj).Assign(V2O(Args.Values[0]) as Exception);
end;

{  procedure Clear; }
procedure EJvInterpreterError_Clear(var Value: Variant; Args: TArgs);
begin
  EJvInterpreterError(Args.Obj).Clear;
end;

{ property Read ErrCode: integer }
procedure EJvInterpreterError_Read_ErrCode(var Value: Variant; Args: TArgs);
begin
  Value := EJvInterpreterError(Args.Obj).ErrCode;
end;

{ property Read ErrPos: integer }
procedure EJvInterpreterError_Read_ErrPos(var Value: Variant; Args: TArgs);
begin
  Value := EJvInterpreterError(Args.Obj).ErrPos;
end;

{ property Read ErrName: string }
procedure EJvInterpreterError_Read_ErrName(var Value: Variant; Args: TArgs);
begin
  Value := EJvInterpreterError(Args.Obj).ErrName;
end;

{ property Read ErrName2: string }
procedure EJvInterpreterError_Read_ErrName2(var Value: Variant; Args: TArgs);
begin
  Value := EJvInterpreterError(Args.Obj).ErrName2;
end;

{ property Read ErrUnitName: string }
procedure EJvInterpreterError_Read_ErrUnitName(var Value: Variant; Args: TArgs);
begin
  Value := EJvInterpreterError(Args.Obj).ErrUnitName;
end;

{ property Read ErrLine: Integer }
procedure EJvInterpreterError_Read_ErrLine(var Value: Variant; Args: TArgs);
begin
  Value := EJvInterpreterError(Args.Obj).ErrLine;
end;

{ property Read Message1: string }
procedure EJvInterpreterError_Read_Message1(var Value: Variant; Args: TArgs);
begin
...
begin
  ...
  begin
   { EJvInterpreterError }
    AddClass('JvInterpreter', EJvInterpreterError, 'EJvInterpreterError');
    AddGet(EJvInterpreterError, 'Create', EJvInterpreterError_Create, 4, [varInteger, varInteger, varString, varString], varEmpty);
