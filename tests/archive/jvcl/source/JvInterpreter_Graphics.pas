...
begin
  ...
  begin
   { TFontStyle }
    AddConst('Graphics', 'fsBold', Integer(fsBold));
    AddConst('Graphics', 'fsItalic', Integer(fsItalic));
    AddConst('Graphics', 'fsUnderline', Integer(fsUnderline));
    AddConst('Graphics', 'fsStrikeOut', Integer(fsStrikeOut));
   { TFontPitch }
    AddConst('Graphics', 'fpDefault', Integer(fpDefault));
    AddConst('Graphics', 'fpVariable', Integer(fpVariable));
    AddConst('Graphics', 'fpFixed', Integer(fpFixed));
   { TPenStyle }
    AddConst('Graphics', 'psSolid', Integer(psSolid));
    AddConst('Graphics', 'psDash', Integer(psDash));
    AddConst('Graphics', 'psDot', Integer(psDot));
    AddConst('Graphics', 'psDashDot', Integer(psDashDot));
    AddConst('Graphics', 'psDashDotDot', Integer(psDashDotDot));
    AddConst('Graphics', 'psClear', Integer(psClear));
   {$IFDEF COMPLIB_VCL}
    AddConst('Graphics', 'psInsideFrame', Integer(psInsideFrame));
   {$ENDIF COMPLIB_VCL}
   { TPenMode }
    AddConst('Graphics', 'pmBlack', Integer(pmBlack));
    AddConst('Graphics', 'pmWhite', Integer(pmWhite));
    AddConst('Graphics', 'pmNop', Integer(pmNop));
    AddConst('Graphics', 'pmNot', Integer(pmNot));
    AddConst('Graphics', 'pmCopy', Integer(pmCopy));
    AddConst('Graphics', 'pmNotCopy', Integer(pmNotCopy));
    AddConst('Graphics', 'pmMergePenNot', Integer(pmMergePenNot));
    AddConst('Graphics', 'pmMaskPenNot', Integer(pmMaskPenNot));
    AddConst('Graphics', 'pmMergeNotPen', Integer(pmMergeNotPen));
    AddConst('Graphics', 'pmMaskNotPen', Integer(pmMaskNotPen));
    AddConst('Graphics', 'pmMerge', Integer(pmMerge));
    AddConst('Graphics', 'pmNotMerge', Integer(pmNotMerge));
    AddConst('Graphics', 'pmMask', Integer(pmMask));
    AddConst('Graphics', 'pmNotMask', Integer(pmNotMask));
    AddConst('Graphics', 'pmXor', Integer(pmXor));
    AddConst('Graphics', 'pmNotXor', Integer(pmNotXor));
   { TBrushStyle }
    AddConst('Graphics', 'bsSolid', Integer(bsSolid));
    AddConst('Graphics', 'bsClear', Integer(bsClear));
    AddConst('Graphics', 'bsHorizontal', Integer(bsHorizontal));
    AddConst('Graphics', 'bsVertical', Integer(bsVertical));
    AddConst('Graphics', 'bsFDiagonal', Integer(bsFDiagonal));
    AddConst('Graphics', 'bsBDiagonal', Integer(bsBDiagonal));
    AddConst('Graphics', 'bsCross', Integer(bsCross));
    AddConst('Graphics', 'bsDiagCross', Integer(bsDiagCross));
   { TFont }
   ...
   {$IFDEF COMPLIB_VCL}
   { TFillStyle }
    AddConst('Graphics', 'fsSurface', Integer(fsSurface));
    AddConst('Graphics', 'fsBorder', Integer(fsBorder));
   { TFillMode }
    AddConst('Graphics', 'fmAlternate', Integer(fmAlternate));
    AddConst('Graphics', 'fmWinding', Integer(fmWinding));
   {$ENDIF COMPLIB_VCL}
   { TCanvasStates }
    AddConst('Graphics', 'csHandleValid', Integer(csHandleValid));
    AddConst('Graphics', 'csFontValid', Integer(csFontValid));
    AddConst('Graphics', 'csPenValid', Integer(csPenValid));
    AddConst('Graphics', 'csBrushValid', Integer(csBrushValid));
   { TCanvas }
    AddClass('Graphics', TCanvas, 'TCanvas');
    AddGet(TCanvas, 'Create', TCanvas_Create, 0, [0], varEmpty);
    AddGet(TCanvas, 'Arc', TCanvas_Arc, 8, [varEmpty, varEmpty, varEmpty, varEmpty, varEmpty, varEmpty, varEmpty, varEmpty], varEmpty);
   {$IFDEF COMPLIB_VCL}
    AddGet(TCanvas, 'BrushCopy', TCanvas_BrushCopy, 4, [varEmpty, varEmpty, varEmpty, varEmpty], varEmpty);
   {$ENDIF COMPLIB_VCL}
    AddGet(TCanvas, 'Chord', TCanvas_Chord, 8, [varEmpty, varEmpty, varEmpty, varEmpty, varEmpty, varEmpty, varEmpty, varEmpty], varEmpty);
   ...
   {$ENDIF COMPILER3_UP}
    ...
    AddGet(TCanvas, 'RoundRect', TCanvas_RoundRect, 6, [varEmpty, varEmpty, varEmpty, varEmpty, varEmpty, varEmpty], varEmpty);
   ...
   {$IFDEF COMPLIB_VCL}
    AddGet(TGraphic, 'LoadFromClipboardFormat', TGraphic_LoadFromClipboardFormat, 3, [varEmpty, varEmpty, varEmpty], varEmpty);
    AddGet(TGraphic, 'SaveToClipboardFormat', TGraphic_SaveToClipboardFormat, 3, [varByRef, varByRef, varByRef], varEmpty);
   {$ENDIF COMPLIB_VCL}
   ...
   {$IFDEF COMPLIB_VCL}
    AddGet(TPicture, 'LoadFromClipboardFormat', TPicture_LoadFromClipboardFormat, 3, [varEmpty, varEmpty, varEmpty], varEmpty);
    AddGet(TPicture, 'SaveToClipboardFormat', TPicture_SaveToClipboardFormat, 3, [varByRef, varByRef, varByRef], varEmpty);
   ...
   { TPixelFormat }
    AddConst('Graphics', 'pfDevice', Integer(pfDevice));
    AddConst('Graphics', 'pf1bit', Integer(pf1bit));
    AddConst('Graphics', 'pf4bit', Integer(pf4bit));
    AddConst('Graphics', 'pf8bit', Integer(pf8bit));
    AddConst('Graphics', 'pf15bit', Integer(pf15bit));
    AddConst('Graphics', 'pf16bit', Integer(pf16bit));
    AddConst('Graphics', 'pf24bit', Integer(pf24bit));
    AddConst('Graphics', 'pf32bit', Integer(pf32bit));
    AddConst('Graphics', 'pfCustom', Integer(pfCustom));
   { TTransparentMode }
   ...
   {$IFDEF COMPLIB_VCL}
    AddGet(TBitmap, 'LoadFromClipboardFormat', TBitmap_LoadFromClipboardFormat, 3, [varEmpty, varEmpty, varEmpty], varEmpty);
   {$ENDIF COMPLIB_VCL}
