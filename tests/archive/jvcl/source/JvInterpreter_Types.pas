...
uses Types, Variants, JvInterpreter;
...
begin
  ...
  begin
    AddExtUnit('Types');
   { TPoint }
    AddRec('Types', 'TPoint', sizeof(TPoint), [RFD('X', 0, varInteger), RFD('Y', 4, varInteger)], nil, nil, nil);
    AddFun('Types', 'Point', JvInterpreter_Point, 2, [varInteger, varInteger], varRecord);
   { TRect }
    AddRec('Types', 'TRect', sizeof(TRect), [RFD('Left', 0, varInteger), RFD('Top', 4, varInteger), RFD('Right', 8, varInteger), RFD('Bottom', 12, varInteger)], nil, nil, nil);
    AddFun('Types', 'Rect', JvInterpreter_Rect, 4, [varInteger, varInteger, varInteger, varInteger], varRecord);
    AddFun('Types', 'Bounds', JvInterpreter_Bounds, 4, [varInteger, varInteger, varInteger, varInteger], varRecord);
    AddRecGet('Types', 'TRect', 'TopLeft', TRect_Read_TopLeft, 0, [0], varRecord);
    AddRecSet('Types', 'TRect', 'TopLeft', TRect_Write_TopLeft, 0, [0]);
    AddRecGet('Types', 'TRect', 'BottomRight', TRect_Read_BottomRight, 0, [0], varRecord);
    AddRecSet('Types', 'TRect', 'BottomRight', TRect_Write_BottomRight, 0, [0]);
  end;    { with }
