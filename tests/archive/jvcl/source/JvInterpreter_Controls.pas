...
uses
  Classes,
{$IFDEF COMPLIB_VCL}
  Graphics, Controls, Menus {$IFDEF COMPILER4_UP},ImgList{$ENDIF COMPILER4_UP}, JvInterpreter_Windows
{$ENDIF COMPLIB_VCL}
{$IFDEF COMPLIB_CLX}
...
procedure JvInterpreter_IsDragObject(var Value: Variant; Args: TArgs);
begin
...
procedure JvInterpreter_FindControl(var Value: Variant; Args: TArgs);
begin
{$IFDEF COMPLIB_VCL}
...
procedure JvInterpreter_FindVCLWindow(var Value: Variant; Args: TArgs);
begin
...
procedure JvInterpreter_FindDragTarget(var Value: Variant; Args: TArgs);
begin
  Value := O2V(FindDragTarget(Var2Point(Args.Values[0]), Args.Values[1]));
end;

{ function GetCaptureControl: TControl; }
procedure JvInterpreter_GetCaptureControl(var Value: Variant; Args: TArgs);
begin
  Value := O2V(GetCaptureControl);
end;

{ procedure SetCaptureControl(Control: TControl); }
procedure JvInterpreter_SetCaptureControl(var Value: Variant; Args: TArgs);
begin
...
procedure JvInterpreter_CancelDrag(var Value: Variant; Args: TArgs);
begin
  CancelDrag;
end;
{$ENDIF COMPLIB_VCL}
...
procedure JvInterpreter_CursorToString(var Value: Variant; Args: TArgs);
begin
  Value := CursorToString(Args.Values[0]);
end;

{ function StringToCursor(const S: string): TCursor; }
procedure JvInterpreter_StringToCursor(var Value: Variant; Args: TArgs);
begin
  Value := StringToCursor(Args.Values[0]);
end;

{ function CursorToIdent(Cursor: Longint; var Ident: string): Boolean; }
procedure JvInterpreter_CursorToIdent(var Value: Variant; Args: TArgs);
begin
  Value := CursorToIdent(Args.Values[0], string(TVarData(Args.Values[1]).vString));
end;

{ function IdentToCursor(const Ident: string; var Cursor: Longint): Boolean; }
procedure JvInterpreter_IdentToCursor(var Value: Variant; Args: TArgs);
begin
  Value := IdentToCursor(Args.Values[0], longint(TVarData(Args.Values[1]).vInteger));
end;

{ function GetShortHint(const Hint: string): string; }
procedure JvInterpreter_GetShortHint(var Value: Variant; Args: TArgs);
begin
  Value := GetShortHint(Args.Values[0]);
end;

{ function GetLongHint(const Hint: string): string; }
procedure JvInterpreter_GetLongHint(var Value: Variant; Args: TArgs);
begin
...
procedure JvInterpreter_InitWndProc(var Value: Variant; Args: TArgs);
begin
...
procedure JvInterpreter_SendAppMessage(var Value: Variant; Args: TArgs);
begin
  Value := SendAppMessage(Args.Values[0], Args.Values[1], Args.Values[2]);
end;

{ procedure MoveWindowOrg(DC: HDC; DX, DY: Integer); }
procedure JvInterpreter_MoveWindowOrg(var Value: Variant; Args: TArgs);
begin
...
procedure TJvInterpreterControlsEvent.MouseEvent(Sender: TObject; Button: TMouseButton; Shift: TShiftState; X, Y: Integer);
begin
...
begin
  ...
  begin
   ...
   {$IFDEF COMPLIB_VCL}
    AddFun('Controls', 'IsDragObject', JvInterpreter_IsDragObject, 1, [varEmpty], varEmpty);
   {$ENDIF COMPLIB_VCL}
    AddFun('Controls', 'FindControl', JvInterpreter_FindControl, 1, [varEmpty], varEmpty);
   {$IFDEF COMPLIB_VCL}
    AddFun('Controls', 'FindVCLWindow', JvInterpreter_FindVCLWindow, 1, [varEmpty], varEmpty);
   {$ENDIF COMPLIB_VCL}
    AddFun('Controls', 'FindDragTarget', JvInterpreter_FindDragTarget, 2, [varEmpty, varEmpty], varEmpty);
    AddFun('Controls', 'GetCaptureControl', JvInterpreter_GetCaptureControl, 0, [0], varEmpty);
    AddFun('Controls', 'SetCaptureControl', JvInterpreter_SetCaptureControl, 1, [varEmpty], varEmpty);
   {$IFDEF COMPLIB_VCL}
    AddFun('Controls', 'CancelDrag', JvInterpreter_CancelDrag, 0, [0], varEmpty);
   {$ENDIF COMPLIB_VCL}
    AddFun('Controls', 'CursorToString', JvInterpreter_CursorToString, 1, [varEmpty], varEmpty);
    AddFun('Controls', 'StringToCursor', JvInterpreter_StringToCursor, 1, [varEmpty], varEmpty);
    AddFun('Controls', 'CursorToIdent', JvInterpreter_CursorToIdent, 2, [varEmpty, varByRef], varEmpty);
    AddFun('Controls', 'IdentToCursor', JvInterpreter_IdentToCursor, 2, [varEmpty, varByRef], varEmpty);
    AddFun('Controls', 'GetShortHint', JvInterpreter_GetShortHint, 1, [varEmpty], varEmpty);
    AddFun('Controls', 'GetLongHint', JvInterpreter_GetLongHint, 1, [varEmpty], varEmpty);
   {$IFDEF COMPLIB_VCL}
    AddFun('Controls', 'InitWndProc', JvInterpreter_InitWndProc, 4, [varEmpty, varEmpty, varEmpty, varEmpty], varEmpty);
    AddFun('Controls', 'SendAppMessage', JvInterpreter_SendAppMessage, 3, [varEmpty, varEmpty, varEmpty], varEmpty);
    AddFun('Controls', 'MoveWindowOrg', JvInterpreter_MoveWindowOrg, 3, [varEmpty, varEmpty, varEmpty], varEmpty);
   {$ENDIF COMPLIB_VCL}

    AddHandler('Controls', 'TMouseEvent', TJvInterpreterControlsEvent, @TJvInterpreterControlsEvent.MouseEvent);
    AddHandler('Controls', 'TMouseMoveEvent', TJvInterpreterControlsEvent, @TJvInterpreterControlsEvent.MouseMoveEvent);
    AddHandler('Controls', 'TKeyEvent', TJvInterpreterControlsEvent, @TJvInterpreterControlsEvent.KeyEvent);
    AddHandler('Controls', 'TKeyPressEvent', TJvInterpreterControlsEvent, @TJvInterpreterControlsEvent.KeyPressEvent);
    AddHandler('Controls', 'TDragOverEvent', TJvInterpreterControlsEvent, @TJvInterpreterControlsEvent.DragOverEvent);
    AddHandler('Controls', 'TDragDropEvent', TJvInterpreterControlsEvent, @TJvInterpreterControlsEvent.DragDropEvent);
    AddHandler('Controls', 'TStartDragEvent', TJvInterpreterControlsEvent, @TJvInterpreterControlsEvent.StartDragEvent);
    AddHandler('Controls', 'TEndDragEvent', TJvInterpreterControlsEvent, @TJvInterpreterControlsEvent.EndDragEvent);
  end;    { with }
