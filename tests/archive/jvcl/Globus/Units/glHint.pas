{ 
 ...
 			  ' GLOBUS LIB '			   
  ...
  
 ===================================================================
 glHint unit 12.1998                               component TglHint
 ...
 Feel free to change paint style on your own taste :)
 ===================================================================}
unit glHint;
...
TglHintWindow = class(THintWindow)
private
  //procedure CMTextChanged(var Message: TMessage); message CM_TEXTCHANGED;
protected
  AFrHintComponent : TglHint;
...
implementation
uses glTypes, glUtils, ExtCtrls;
{$R glHint.res}
constructor TglHint.Create(AOwner: TComponent);
begin
  inherited;
  {if (csDesigning in ComponentState) then }InitHint;
  Application.ShowHint := false;
  Application.ShowHint := true;
//  HW := TglHintWindow.Create(Application);
end;

destructor TglHint.Destroy;
begin
...
procedure TglHint.Notification( Component: TComponent; Operation: TOperation );
begin
  if (Component <> Self)and(Operation = opInsert)and(Component is TglHint ) then
    raise Exception.Create('Cannot create more than one instance of TglHint component');
end;

procedure TglHint.InitHint;
begin
  with Application do begin
    ...
    OnHint := OnHintNew;
    HintWindowClass := TglHintWindow;
    lpFrHintComponent := Self;
  end;
  FShowHint := true;
end;

procedure TglHint.Loaded;
begin
  inherited;
...
procedure TglHint.OnHintNew(Sender: TObject);
begin
  if Assigned(FOnHint) then FOnHint(Sender);
end;

procedure TglHint.OnShowHintNew(var HintStr: string;
...
procedure TglHint.ShowHintAt(x, y: integer; Caption: string);
var
  R: TRect;
  HW: TglHintWindow;
begin
...
begin
  inherited;
  AFrHintComponent := TglHint(lpFrHintComponent);
  try
...
procedure TglHintWindow.CreateParams(var Params: TCreateParams);
begin
...
procedure TglHintWindow.ActivateHint(Rect: TRect; const AHint: string);
//var h,w : integer;
begin
  Caption := AHint;
  BoundsRect := Rect;
...
procedure TglHintWindow.WMKillFocus(var Message: TMessage);
begin
  hide;
end;
