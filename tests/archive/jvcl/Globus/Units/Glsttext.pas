{ 
 ...
 			  ' GLOBUS LIB '			   
  ...
  
 ===================================================================
 glStText Unit 07.199 			      component glStaticText
 ===================================================================
}
unit glStText;
...
type
  ...
  TglStaticText_ = class(TGraphicControl)
  private
    FActiveColor        : TColor;
...
procedure Register;
begin
  RegisterComponents('Proba', [TglStaticText_]);
end;
{~~~~~~~~~~~~~~~~~~~~~~~~~}
//________________________________________________________ Methods _
constructor TglStaticText_.Create( AOwner : TComponent );
begin
...
//______
destructor TglStaticText_.Destroy;
begin
//  Image.Free;
  inherited Destroy;
end;
//______
procedure TglStaticText_.CMFontChanged(var Message: TMessage);
begin
  inherited;
end;
//______
procedure TglStaticText_.Loaded;
begin
  inherited;
  CreateImage;
end;
//______
procedure TglStaticText_.CMMouseEnter(var Message: TMessage);
begin
  fActive:=true; paint;
  if Assigned(FOnMouseEnter) then FOnMouseEnter(self);
end;

procedure TglStaticText_.CMMouseLeave(var Message: TMessage);
begin
  fActive:=false; paint;
  if Assigned(FOnMouseLeave) then FOnMouseLeave(self);
end;
//______
procedure TglStaticText_.Paint;
const
...
begin
  ...
  if fActive then SetTextColor( Canvas.Handle, ColorToRGB(ActiveColor) )
             else SetTextColor( Canvas.Handle, ColorToRGB(Font.Color) );
...
//  BitBlt( Canvas.Handle, 0, 0, Width, Height, Image.Canvas.Handle, Width, Height, SRCCOPY );
  ...
  begin
    if FWordWrap then begin DrawTextBroadwise; exit; end
...
//______
procedure TglStaticText_.CreateImage;
begin
//  DrawTextBroadwise;
end;
//______
procedure TglStaticText_.DrawTextBroadwise;
var
...
//    if LexemCount=0 then Lexem:=Lexem+' ';
    ...
    begin
      ...
      LexemCount := 0; LineWidth := 0; //TextHeight := 0;
    end
    else Pos1:=Pos2;
...
procedure TglStaticText_.AdjustBounds;
const
  WordWraps: array[Boolean] of Word = (0, DT_WORDBREAK);
var
  DC: HDC;
...
procedure TglStaticText_.SetAlignment(Value: TglAlignment);
begin
  FAlignment := Value; Invalidate;
end;

procedure TglStaticText_.SetAutoSize(Value: boolean);
begin
  FAutoSize := Value; AdjustBounds; Repaint;
end;

procedure TglStaticText_.SetTransparent(Value: boolean);
begin
  FTransparent := Value; Repaint;
end;

procedure TglStaticText_.SetWordWrap(Value: boolean);
begin
