...
uses Classes,
     ...
     glHint, gl3DCol, glCapt, glprgrs, glHShape, glSplit, glJump,
     glDigits, glGrBox, glImage, glShadow, glLBox, glALBox, glSBox, glGBtn,{ glRLabel,}
     glBitBtn, glRuler, glSGrid, glProcs, glSysInf, {glShape,}
     ...
     glSmallFontsDefence, glWizardHeader, glXMLSerializer,
...
procedure Register;
begin
  RegisterComponents( 'Gl Controls', [ TglSplitter, TglBevel, TglLabel, TglBitBtn, TglGraphicButton,TglMaskEdit ,TglCheckBox, TglTreeView, TglCheckTreeView, TglFlyingText,
  ...
  RegisterComponents( 'Gl Components', [ Tgl3DColors, TglCaption, TglHint, TglProcess, TglSysInfo,
                                        ...
                                        TglSmallFontsDefence, TglXMLSerializer{, TglMultiResources}]);
