...
uses
  ...
  JvColorCombo, JvComponent, JvCtrls;

type
  TForm1 = class(TForm)
    ImageList1: TImageList;
    Panel2: TPanel;
    JvListBox1: TJvListBox3;
    Splitter1: TSplitter;
    Panel3: TPanel;
    Button2: TButton;
    JvComboBox1: TJvComboBox3;
    CheckBox1: TCheckBox;
    JvColorComboBox1: TJvColorComboBox;
    JvFontComboBox1: TJvFontComboBox2;
...
begin
  case JvListBox1.TextAlign of
    taLeftJustify: JvListBox1.TextAlign := taRightJustify;
    taRightJustify: JvListBox1.TextAlign := taCenter;
    taCenter: JvListBox1.TextAlign := taLeftJustify;
  end;
end;
