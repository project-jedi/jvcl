...
procedure TfrmMain.lvImagesSelectItem(Sender: TObject; Item: TListItem;
  Selected: Boolean);
begin
...
procedure TfrmMain.DoDateChange(Sender:TObject);
begin
...
procedure TfrmMain.DoDblClick(Sender:TObject);
begin
  mnuEditMemo.Click;
end;
...
procedure TfrmMain.btnMonthFontClick(Sender: TObject);
begin
  with TFontDialog.Create(nil) do
  try
    Font := sl.MonthFont;
...
procedure TfrmMain.udDayWidthClick(Sender: TObject; Button: TUDBtnType);
begin
...
procedure TfrmMain.chkFlatClick(Sender: TObject);
const
...
procedure TfrmMain.dtpFirstDateChange(Sender: TObject);
begin
  sl.Date := dtpFirstDate.Date;
end;

// update the selected date from the datetimepicker
procedure TfrmMain.dtpSelDateChange(Sender: TObject);
begin
  sl.SelDate := dtpSelDate.Date;
end;
...
procedure TfrmMain.btnPenColorClick(Sender: TObject);
begin
  with TColorDialog.Create(nil) do
  try
...
procedure TfrmMain.udPenWidthClick(Sender: TObject; Button: TUDBtnType);
begin
  sl.Selection.Pen.Width := udPenWidth.Position;
end;

// changes the background Color of Today 
procedure TfrmMain.btnTodayColorClick(Sender: TObject);
begin
  with TColorDialog.Create(nil) do
  try
    Color := sl.TodayColor;
...
procedure TfrmMain.chkRClickClick(Sender: TObject);
begin
  sl.RightClickSelect := chkRClick.Checked;
end;

// move today to the middle of the timeline; looks better
procedure TfrmMain.mnuTodayClick(Sender: TObject);
begin
...
procedure TfrmMain.mnuInsertImageClick(Sender: TObject);
begin
...
// the arrow-keys
procedure TfrmMain.udScrollSmallClick(Sender: TObject; Button: TUDBtnType);
begin
  sl.SmallChange := udScrollSmall.Position;
end;

// the LargeChange value is used when you hold the Ctrl key while scrolling
procedure TfrmMain.udScrollLargeClick(Sender: TObject; Button: TUDBtnType);
begin
...
procedure TfrmMain.mnuEditMemoClick(Sender: TObject);
...
procedure TfrmMain.DoObjectSave(Sender:TObject;Stream:TStream;const AObject:TObject);
...
procedure TfrmMain.DoObjectLoad(Sender:TObject;Stream:TStream;var AObject:TObject);
var S:string;Count:integer;
begin
...
procedure TfrmMain.lbObjFontStyleClickCheck(Sender: TObject);
var F:TFontStyles;
begin
  F := [];
...
procedure TfrmMain.mnuGotoDateClick(Sender: TObject);
begin
...
// display options:
procedure TfrmMain.chkShowMonthsClick(Sender: TObject);
begin
  sl.ShowMonths := chkShowMonths.Checked;
end;

procedure TfrmMain.chkShowWeeksClick(Sender: TObject);
begin
  sl.ShowWeeks := chkShowWeeks.Checked;
end;

procedure TfrmMain.chkShowTodayClick(Sender: TObject);
begin
...
procedure TfrmMain.btnLineColorClick(Sender: TObject);
begin
  with TColorDialog.Create(nil) do
  try
    Color := sl.LineColor;
