...
type
  ...
  TJvFormatDrive2 = class(TCommonDialog)
  private
...
constructor TJvFormatDrive2.Create(AOwner: TComponent);
begin
...
function TJvFormatDrive2.Execute: boolean;
...
procedure TJvFormatDrive2.DoError(ErrValue: integer);
...
procedure TJvFormatDrive2.SetDrive(Value: TJvDriveLetters);
begin
