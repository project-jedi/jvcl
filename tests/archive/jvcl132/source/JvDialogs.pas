...
begin
  ...
  FParentWndInstance :=  {$IFDEF DELPHI6_UP}Classes.{$ENDIF}MakeObjectInstance(ParentWndProc);
end;

destructor TJvOpenDialog.Destroy;
begin
   {$IFDEF DELPHI6_UP}Classes.{$ENDIF}FreeObjectInstance(FParentWndInstance);
  inherited;
end;
