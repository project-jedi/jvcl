...
begin
  ...
  case SystemFont of
    fsfSmallFont: Test(GetDeviceCaps(DC, LOGPIXELSX) = 96,
        Format(RsSystemFont, ['мелкий']));
    fsfBigFont: Test(GetDeviceCaps(DC, LOGPIXELSX) = 120,
        Format(RsSystemFont, ['крупный']));
  end;
