...
uses
  ...
  Grids, JvgStringGrid, stdctrls, dsgnintf, JvgReport, Buttons, ExtCtrls, mask;
...
procedure TJvgReportParamsEditor.Notification(AComponent: TComponent; Operation: TOperation);
begin
