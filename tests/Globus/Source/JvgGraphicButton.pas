...
uses
  Windows, Messages, SysUtils, Classes, Graphics, controls, JvgTypes, JvgUtils;
...
procedure TJvgGraphicButton.MouseDown(Button: TMouseButton; Shift: TShiftState; X, Y: Integer);
begin
...
procedure TJvgGraphicButton.MouseUp(Button: TMouseButton; Shift: TShiftState; X, Y: Integer);
begin
