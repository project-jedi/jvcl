...
uses
  ...
  JvgTypes, JvgUtils, JvgCommClasses, StdCtrls, ExtCtrls;
...
procedure TJvgCaption.Notification(Component: TComponent; Operation: TOperation);
begin
  if (Component <> Self) and (Operation = opInsert) and (Component is TJvgCaption) then
    raise Exception.Create('Cannot create more than one instance of TJvgCaption component');
end;
//=========================================================.special procs.
