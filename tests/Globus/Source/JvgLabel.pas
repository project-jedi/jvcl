...
begin
  ...
  if floTransparentFont in Options then
    ...
    fBufferedDraw := (floBufferedDraw in Options) and not (csDesigning in ComponentState);
  ...
  if {fNeedRemakeTextureMask and}  fUseTextureBmp or (floTransparentFont in Options) then
  begin
