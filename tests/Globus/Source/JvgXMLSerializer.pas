...
implementation
uses JvgUtils{$IFDEF COMPILER6_UP}, DesignIntf{$ELSE}{$IFDEF COMPILER5_UP}, dsgnintf{$ENDIF}{$ENDIF};
...
begin
  if not Expr then raise EJvgXMLSerializerException.Create('EJvgXMLSerializerException'#13#10#13#10 + Message);
end;
