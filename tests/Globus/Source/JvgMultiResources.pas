...
implementation
uses StdCtrls; //, JvgMultiResourceEditor;

procedure Register;
begin
  RegisterComponents('Proba', [TJvgMultipleResources]);
...
procedure TJvgMultipleResources.Notification(Component: TComponent; Operation: TOperation);
var
  i, j: integer;
begin
  inherited;
...
procedure TJvgMultipleResources.GetComponentData(C: TComponent; SLNames: TStringList);
var
  i: integer;
begin
  if C is TLabel then
