...
procedure TJvgReportEditorForm.OnMouseDown_(Sender: TObject; Button: TMouseButton; Shift: TShiftState; X, Y: Integer);
var
  R: TRect;
  pt: TPoint;
  i: integer;
...
procedure TJvgReportEditorForm.OnMouseMove_(Sender: TObject; Shift: TShiftState; X, Y: Integer);
var
  DC: HDC;
  i: integer;
begin
...
procedure TJvgReportEditorForm.ScrollBox_MouseMove(Sender: TObject; Shift: TShiftState;
  X, Y: Integer);
var
  DC: HDC;
  pt: TPoint;
