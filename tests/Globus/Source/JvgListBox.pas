...
//______________________________________________________________
procedure TJvgListBox.Notification(AComponent: TComponent; Operation: TOperation);
begin
...
procedure TJvgCheckListBox.MouseDown(Button: TMouseButton; Shift: TShiftState; X, Y: Integer);
var
  APoint: TPoint;
  Index: integer;
begin
