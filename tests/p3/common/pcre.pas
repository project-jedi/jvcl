 ...
 *
 * Translated to Object Pascal by Peter Thornqvist (peter3@peter3.com), 2002-08-05
 * NOTE: if you enable static linking of the PCRE.DLL, this means that the pcre.dll *must*
 * be in the users path or an AV will occur at startup
 *)
{$WEAKPACKAGEUNIT ON}

// (p3) this is the switch to change between static and dynamic linking.
// it is set to dynamic by default here.
// To disable simply insert a '.' before the '$' 
