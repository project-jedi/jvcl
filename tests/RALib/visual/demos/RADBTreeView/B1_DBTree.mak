...
!endif
# ---------------------------------------------------------------------------
PROJECT = B1_DBTree.exe
OBJFILES = fDBTree.obj B1_DBTree.obj
RESFILES = B1_DBTree.res
RESDEPEN = $(RESFILES) fDBTree.dfm
LIBFILES = 
DEFFILE = 
# ---------------------------------------------------------------------------
...
PFLAGS = -AWinTypes=Windows;WinProcs=Windows;DbiTypes=BDE;DbiProcs=BDE;DbiErrs=BDE \
   ...
   -I$(BCB)\include;$(BCB)\include\vcl -v -$Y -$W -$O- -JPHNV -M     
