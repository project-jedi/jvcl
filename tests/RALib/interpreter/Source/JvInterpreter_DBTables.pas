...
begin
  ...
  begin
   ...
   {$ENDIF COMPILER3_UP}
    ...
    AddGet(TSession, 'GetPassword', TSession_GetPassword, 0, [0], varEmpty);
    AddGet(TSession, 'GetTableNames', TSession_GetTableNames, 5, [varEmpty, varEmpty, varEmpty, varEmpty, varEmpty], varEmpty);
   ...
   {$ENDIF COMPILER3_UP}
    ...
    AddGet(TSession, 'SaveConfigFile', TSession_SaveConfigFile, 0, [0], varEmpty);
    AddGet(TSession, 'DatabaseCount', TSession_Read_DatabaseCount, 0, [0], varEmpty);
    AddGet(TSession, 'Databases', TSession_Read_Databases, 1, [0], varEmpty);
    AddGet(TSession, 'Handle', TSession_Read_Handle, 0, [0], varEmpty);
    AddGet(TSession, 'Locale', TSession_Read_Locale, 0, [0], varEmpty);
    AddGet(TSession, 'TraceFlags', TSession_Read_TraceFlags, 0, [0], varEmpty);
   ...
   {$ENDIF COMPILER3_UP}
    ...
    AddGet(TSession, 'PrivateDir', TSession_Read_PrivateDir, 0, [0], varEmpty);
   ...
   // AddGet(TDatabase, 'ApplyUpdates', TDatabase_ApplyUpdates, 1, [varEmpty], nil);
    AddGet(TDatabase, 'Close', TDatabase_Close, 0, [0], varEmpty);
    AddGet(TDatabase, 'CloseDataSets', TDatabase_CloseDataSets, 0, [0], varEmpty);
    AddGet(TDatabase, 'Commit', TDatabase_Commit, 0, [0], varEmpty);
    AddGet(TDatabase, 'FlushSchemaCache', TDatabase_FlushSchemaCache, 1, [varEmpty], varEmpty);
    AddGet(TDatabase, 'Open', TDatabase_Open, 0, [0], varEmpty);
    AddGet(TDatabase, 'Rollback', TDatabase_Rollback, 0, [0], varEmpty);
    AddGet(TDatabase, 'StartTransaction', TDatabase_StartTransaction, 0, [0], varEmpty);
    AddGet(TDatabase, 'ValidateName', TDatabase_ValidateName, 1, [varEmpty], varEmpty);
    AddGet(TDatabase, 'DataSetCount', TDatabase_Read_DataSetCount, 0, [0], varEmpty);
    AddIGet(TDatabase, 'DataSets', TDatabase_Read_DataSets, 1, [0], varEmpty);
    AddGet(TDatabase, 'Directory', TDatabase_Read_Directory, 0, [0], varEmpty);
    AddSet(TDatabase, 'Directory', TDatabase_Write_Directory, 0, [0]);
    AddGet(TDatabase, 'Handle', TDatabase_Read_Handle, 0, [0], varEmpty);
    AddSet(TDatabase, 'Handle', TDatabase_Write_Handle, 0, [0]);
    AddGet(TDatabase, 'IsSQLBased', TDatabase_Read_IsSQLBased, 0, [0], varEmpty);
    AddGet(TDatabase, 'InTransaction', TDatabase_Read_InTransaction, 0, [0], varEmpty);
    AddGet(TDatabase, 'Locale', TDatabase_Read_Locale, 0, [0], varEmpty);
    AddGet(TDatabase, 'Session', TDatabase_Read_Session, 0, [0], varEmpty);
    AddGet(TDatabase, 'Temporary', TDatabase_Read_Temporary, 0, [0], varEmpty);
    AddSet(TDatabase, 'Temporary', TDatabase_Write_Temporary, 0, [0]);
    AddGet(TDatabase, 'SessionAlias', TDatabase_Read_SessionAlias, 0, [0], varEmpty);
    AddGet(TDatabase, 'TraceFlags', TDatabase_Read_TraceFlags, 0, [0], varEmpty);
    AddSet(TDatabase, 'TraceFlags', TDatabase_Write_TraceFlags, 0, [0]);
    AddGet(TDatabase, 'AliasName', TDatabase_Read_AliasName, 0, [0], varEmpty);
    AddSet(TDatabase, 'AliasName', TDatabase_Write_AliasName, 0, [0]);
    AddGet(TDatabase, 'Connected', TDatabase_Read_Connected, 0, [0], varEmpty);
    AddSet(TDatabase, 'Connected', TDatabase_Write_Connected, 0, [0]);
    AddGet(TDatabase, 'DatabaseName', TDatabase_Read_DatabaseName, 0, [0], varEmpty);
   ...
   {$ENDIF COMPILER3_UP}
    ...
    AddGet(TDatabase, 'Params', TDatabase_Read_Params, 0, [0], varEmpty);
    AddSet(TDatabase, 'Params', TDatabase_Write_Params, 0, [0]);
    AddGet(TDatabase, 'SessionName', TDatabase_Read_SessionName, 0, [0], varEmpty);
   ...
   {$ENDIF COMPILER3_UP}
    ...
    AddGet(TBDEDataSet, 'Locale', TBDEDataSet_Read_Locale, 0, [0], varEmpty);
    AddGet(TBDEDataSet, 'UpdateObject', TBDEDataSet_Read_UpdateObject, 0, [0], varEmpty);
    AddSet(TBDEDataSet, 'UpdateObject', TBDEDataSet_Write_UpdateObject, 0, [0]);
    AddGet(TBDEDataSet, 'UpdatesPending', TBDEDataSet_Read_UpdatesPending, 0, [0], varEmpty);
    AddGet(TBDEDataSet, 'UpdateRecordTypes', TBDEDataSet_Read_UpdateRecordTypes, 0, [0], varEmpty);
   ...
   {$ENDIF COMPILER3_UP}
    ...
    AddGet(TDBDataSet, 'DBSession', TDBDataSet_Read_DBSession, 0, [0], varEmpty);
    AddGet(TDBDataSet, 'DatabaseName', TDBDataSet_Read_DatabaseName, 0, [0], varEmpty);
   ...
   { TTable }
    ...
    AddGet(TTable, 'ApplyRange', TTable_ApplyRange, 0, [0], varEmpty);
    AddGet(TTable, 'CancelRange', TTable_CancelRange, 0, [0], varEmpty);
    AddGet(TTable, 'CloseIndexFile', TTable_CloseIndexFile, 1, [varEmpty], varEmpty);
    AddGet(TTable, 'CreateTable', TTable_CreateTable, 0, [0], varEmpty);
    AddGet(TTable, 'DeleteIndex', TTable_DeleteIndex, 1, [varEmpty], varEmpty);
    AddGet(TTable, 'DeleteTable', TTable_DeleteTable, 0, [0], varEmpty);
    AddGet(TTable, 'EditKey', TTable_EditKey, 0, [0], varEmpty);
    AddGet(TTable, 'EditRangeEnd', TTable_EditRangeEnd, 0, [0], varEmpty);
    AddGet(TTable, 'EditRangeStart', TTable_EditRangeStart, 0, [0], varEmpty);
    AddGet(TTable, 'EmptyTable', TTable_EmptyTable, 0, [0], varEmpty);
    ...
    AddGet(TTable, 'GotoKey', TTable_GotoKey, 0, [0], varEmpty);
    AddGet(TTable, 'GotoNearest', TTable_GotoNearest, 0, [0], varEmpty);
    ...
    AddGet(TTable, 'SetKey', TTable_SetKey, 0, [0], varEmpty);
    AddGet(TTable, 'SetRange', TTable_SetRange, 2, [varEmpty, varEmpty], varEmpty);
    AddGet(TTable, 'SetRangeEnd', TTable_SetRangeEnd, 0, [0], varEmpty);
    AddGet(TTable, 'SetRangeStart', TTable_SetRangeStart, 0, [0], varEmpty);
    AddGet(TTable, 'UnlockTable', TTable_UnlockTable, 1, [varEmpty], varEmpty);
    AddGet(TTable, 'IndexDefs', TTable_Read_IndexDefs, 0, [0], varEmpty);
    AddGet(TTable, 'IndexFieldCount', TTable_Read_IndexFieldCount, 0, [0], varEmpty);
    AddIGet(TTable, 'IndexFields', TTable_Read_IndexFields, 1, [0], varEmpty);
    AddISet(TTable, 'IndexFields', TTable_Write_IndexFields, 1, [1]);
    AddGet(TTable, 'KeyExclusive', TTable_Read_KeyExclusive, 0, [0], varEmpty);
   ...
   {$ENDIF COMPILER3_UP}
    ...
    AddGet(TTable, 'IndexFiles', TTable_Read_IndexFiles, 0, [0], varEmpty);
    AddSet(TTable, 'IndexFiles', TTable_Write_IndexFiles, 0, [0]);
    AddGet(TTable, 'IndexName', TTable_Read_IndexName, 0, [0], varEmpty);
    AddSet(TTable, 'IndexName', TTable_Write_IndexName, 0, [0]);
    AddGet(TTable, 'MasterFields', TTable_Read_MasterFields, 0, [0], varEmpty);
    AddSet(TTable, 'MasterFields', TTable_Write_MasterFields, 0, [0]);
    AddGet(TTable, 'MasterSource', TTable_Read_MasterSource, 0, [0], varEmpty);
    AddSet(TTable, 'MasterSource', TTable_Write_MasterSource, 0, [0]);
    AddGet(TTable, 'ReadOnly', TTable_Read_ReadOnly, 0, [0], varEmpty);
    AddSet(TTable, 'ReadOnly', TTable_Write_ReadOnly, 0, [0]);
    AddGet(TTable, 'TableName', TTable_Read_TableName, 0, [0], varEmpty);
    AddSet(TTable, 'TableName', TTable_Write_TableName, 0, [0]);
    AddGet(TTable, 'TableType', TTable_Read_TableType, 0, [0], varEmpty);
   ...
   { TBatchMove }
    ...
    AddGet(TBatchMove, 'Execute', TBatchMove_Execute, 0, [0], varEmpty);
    AddGet(TBatchMove, 'ChangedCount', TBatchMove_Read_ChangedCount, 0, [0], varEmpty);
    AddGet(TBatchMove, 'KeyViolCount', TBatchMove_Read_KeyViolCount, 0, [0], varEmpty);
    AddGet(TBatchMove, 'MovedCount', TBatchMove_Read_MovedCount, 0, [0], varEmpty);
    AddGet(TBatchMove, 'ProblemCount', TBatchMove_Read_ProblemCount, 0, [0], varEmpty);
    AddGet(TBatchMove, 'AbortOnKeyViol', TBatchMove_Read_AbortOnKeyViol, 0, [0], varEmpty);
    AddSet(TBatchMove, 'AbortOnKeyViol', TBatchMove_Write_AbortOnKeyViol, 0, [0]);
    AddGet(TBatchMove, 'AbortOnProblem', TBatchMove_Read_AbortOnProblem, 0, [0], varEmpty);
    AddSet(TBatchMove, 'AbortOnProblem', TBatchMove_Write_AbortOnProblem, 0, [0]);
    AddGet(TBatchMove, 'CommitCount', TBatchMove_Read_CommitCount, 0, [0], varEmpty);
    AddSet(TBatchMove, 'CommitCount', TBatchMove_Write_CommitCount, 0, [0]);
    AddGet(TBatchMove, 'ChangedTableName', TBatchMove_Read_ChangedTableName, 0, [0], varEmpty);
    AddSet(TBatchMove, 'ChangedTableName', TBatchMove_Write_ChangedTableName, 0, [0]);
    AddGet(TBatchMove, 'Destination', TBatchMove_Read_Destination, 0, [0], varEmpty);
    AddSet(TBatchMove, 'Destination', TBatchMove_Write_Destination, 0, [0]);
    AddGet(TBatchMove, 'KeyViolTableName', TBatchMove_Read_KeyViolTableName, 0, [0], varEmpty);
    AddSet(TBatchMove, 'KeyViolTableName', TBatchMove_Write_KeyViolTableName, 0, [0]);
    AddGet(TBatchMove, 'Mappings', TBatchMove_Read_Mappings, 0, [0], varEmpty);
    AddSet(TBatchMove, 'Mappings', TBatchMove_Write_Mappings, 0, [0]);
    AddGet(TBatchMove, 'Mode', TBatchMove_Read_Mode, 0, [0], varEmpty);
    AddSet(TBatchMove, 'Mode', TBatchMove_Write_Mode, 0, [0]);
    AddGet(TBatchMove, 'ProblemTableName', TBatchMove_Read_ProblemTableName, 0, [0], varEmpty);
    AddSet(TBatchMove, 'ProblemTableName', TBatchMove_Write_ProblemTableName, 0, [0]);
    AddGet(TBatchMove, 'RecordCount', TBatchMove_Read_RecordCount, 0, [0], varEmpty);
    AddSet(TBatchMove, 'RecordCount', TBatchMove_Write_RecordCount, 0, [0]);
    AddGet(TBatchMove, 'Source', TBatchMove_Read_Source, 0, [0], varEmpty);
   ...
   {$ENDIF COMPILER3_UP}
    ...
    AddGet(TParam, 'AsDate', TParam_Read_AsDate, 0, [0], varEmpty);
    AddSet(TParam, 'AsDate', TParam_Write_AsDate, 0, [0]);
    AddGet(TParam, 'AsDateTime', TParam_Read_AsDateTime, 0, [0], varEmpty);
    AddSet(TParam, 'AsDateTime', TParam_Write_AsDateTime, 0, [0]);
    AddGet(TParam, 'AsFloat', TParam_Read_AsFloat, 0, [0], varEmpty);
    AddSet(TParam, 'AsFloat', TParam_Write_AsFloat, 0, [0]);
    AddGet(TParam, 'AsInteger', TParam_Read_AsInteger, 0, [0], varEmpty);
   ...
   {$ENDIF COMPILER3_UP}
    ...
    AddGet(TParam, 'AsWord', TParam_Read_AsWord, 0, [0], varEmpty);
    AddSet(TParam, 'AsWord', TParam_Write_AsWord, 0, [0]);
    AddGet(TParam, 'Bound', TParam_Read_Bound, 0, [0], varEmpty);
    AddSet(TParam, 'Bound', TParam_Write_Bound, 0, [0]);
    AddGet(TParam, 'DataType', TParam_Read_DataType, 0, [0], varEmpty);
    AddSet(TParam, 'DataType', TParam_Write_DataType, 0, [0]);
    AddGet(TParam, 'IsNull', TParam_Read_IsNull, 0, [0], varEmpty);
    AddGet(TParam, 'Name', TParam_Read_Name, 0, [0], varEmpty);
    AddSet(TParam, 'Name', TParam_Write_Name, 0, [0]);
    AddGet(TParam, 'ParamType', TParam_Read_ParamType, 0, [0], varEmpty);
    AddSet(TParam, 'ParamType', TParam_Write_ParamType, 0, [0]);
    AddGet(TParam, 'Text', TParam_Read_Text, 0, [0], varEmpty);
    AddSet(TParam, 'Text', TParam_Write_Text, 0, [0]);
    AddGet(TParam, 'Value', TParam_Read_Value, 0, [0], varEmpty);
    AddSet(TParam, 'Value', TParam_Write_Value, 0, [0]);
   { TParams }
    AddClass('DbTables', TParams, 'TParams');
    AddGet(TParams, 'Create', TParams_Create, 0, [0], varEmpty);
    ...
    AddGet(TParams, 'Count', TParams_Count, 0, [0], varEmpty);
    AddGet(TParams, 'Clear', TParams_Clear, 0, [0], varEmpty);
   ...
   { TStoredProc }
    ...
    AddGet(TStoredProc, 'DescriptionsAvailable', TStoredProc_DescriptionsAvailable, 0, [0], varEmpty);
    AddGet(TStoredProc, 'ExecProc', TStoredProc_ExecProc, 0, [0], varEmpty);
    AddGet(TStoredProc, 'ParamByName', TStoredProc_ParamByName, 1, [varEmpty], varEmpty);
    AddGet(TStoredProc, 'Prepare', TStoredProc_Prepare, 0, [0], varEmpty);
    AddGet(TStoredProc, 'GetResults', TStoredProc_GetResults, 0, [0], varEmpty);
    AddGet(TStoredProc, 'UnPrepare', TStoredProc_UnPrepare, 0, [0], varEmpty);
    AddGet(TStoredProc, 'ParamCount', TStoredProc_Read_ParamCount, 0, [0], varEmpty);
    AddGet(TStoredProc, 'StmtHandle', TStoredProc_Read_StmtHandle, 0, [0], varEmpty);
    AddGet(TStoredProc, 'Prepared', TStoredProc_Read_Prepared, 0, [0], varEmpty);
    AddSet(TStoredProc, 'Prepared', TStoredProc_Write_Prepared, 0, [0]);
    AddGet(TStoredProc, 'StoredProcName', TStoredProc_Read_StoredProcName, 0, [0], varEmpty);
    AddSet(TStoredProc, 'StoredProcName', TStoredProc_Write_StoredProcName, 0, [0]);
    AddGet(TStoredProc, 'Overload', TStoredProc_Read_Overload, 0, [0], varEmpty);
    AddSet(TStoredProc, 'Overload', TStoredProc_Write_Overload, 0, [0]);
    AddGet(TStoredProc, 'Params', TStoredProc_Read_Params, 0, [0], varEmpty);
    AddSet(TStoredProc, 'Params', TStoredProc_Write_Params, 0, [0]);
    AddGet(TStoredProc, 'ParamBindMode', TStoredProc_Read_ParamBindMode, 0, [0], varEmpty);
   ...
   { TQuery }
    ...
    AddGet(TQuery, 'ExecSQL', TQuery_ExecSQL, 0, [0], varEmpty);
    AddGet(TQuery, 'ParamByName', TQuery_ParamByName, 1, [varEmpty], varEmpty);
    AddGet(TQuery, 'Prepare', TQuery_Prepare, 0, [0], varEmpty);
    AddGet(TQuery, 'UnPrepare', TQuery_UnPrepare, 0, [0], varEmpty);
    AddGet(TQuery, 'Prepared', TQuery_Read_Prepared, 0, [0], varEmpty);
    AddSet(TQuery, 'Prepared', TQuery_Write_Prepared, 0, [0]);
    AddGet(TQuery, 'ParamCount', TQuery_Read_ParamCount, 0, [0], varEmpty);
    AddGet(TQuery, 'Local', TQuery_Read_Local, 0, [0], varEmpty);
    AddGet(TQuery, 'StmtHandle', TQuery_Read_StmtHandle, 0, [0], varEmpty);
    AddGet(TQuery, 'Text', TQuery_Read_Text, 0, [0], varEmpty);
    AddGet(TQuery, 'RowsAffected', TQuery_Read_RowsAffected, 0, [0], varEmpty);
    AddGet(TQuery, 'SQLBinary', TQuery_Read_SQLBinary, 0, [0], varEmpty);
    AddSet(TQuery, 'SQLBinary', TQuery_Write_SQLBinary, 0, [0]);
    AddGet(TQuery, 'Constrained', TQuery_Read_Constrained, 0, [0], varEmpty);
    AddSet(TQuery, 'Constrained', TQuery_Write_Constrained, 0, [0]);
    AddGet(TQuery, 'DataSource', TQuery_Read_DataSource, 0, [0], varEmpty);
    AddSet(TQuery, 'DataSource', TQuery_Write_DataSource, 0, [0]);
    AddGet(TQuery, 'ParamCheck', TQuery_Read_ParamCheck, 0, [0], varEmpty);
    AddSet(TQuery, 'ParamCheck', TQuery_Write_ParamCheck, 0, [0]);
    AddGet(TQuery, 'RequestLive', TQuery_Read_RequestLive, 0, [0], varEmpty);
    AddSet(TQuery, 'RequestLive', TQuery_Write_RequestLive, 0, [0]);
    AddGet(TQuery, 'SQL', TQuery_Read_SQL, 0, [0], varEmpty);
    AddSet(TQuery, 'SQL', TQuery_Write_SQL, 0, [0]);
    AddGet(TQuery, 'Params', TQuery_Read_Params, 0, [0], varEmpty);
    AddSet(TQuery, 'Params', TQuery_Write_Params, 0, [0]);
    AddGet(TQuery, 'UniDirectional', TQuery_Read_UniDirectional, 0, [0], varEmpty);
   ...
   { TUpdateSQL }
    ...
    AddGet(TUpdateSQL, 'Query', TUpdateSQL_Read_Query, 1, [0], varEmpty);
    AddGet(TUpdateSQL, 'SQL', TUpdateSQL_Read_SQL, 1, [0], varEmpty);
    AddSet(TUpdateSQL, 'SQL', TUpdateSQL_Write_SQL, 1, [1]);
    AddGet(TUpdateSQL, 'ModifySQL', TUpdateSQL_Read_ModifySQL, 0, [0], varEmpty);
    AddSet(TUpdateSQL, 'ModifySQL', TUpdateSQL_Write_ModifySQL, 0, [0]);
    AddGet(TUpdateSQL, 'InsertSQL', TUpdateSQL_Read_InsertSQL, 0, [0], varEmpty);
    AddSet(TUpdateSQL, 'InsertSQL', TUpdateSQL_Write_InsertSQL, 0, [0]);
    AddGet(TUpdateSQL, 'DeleteSQL', TUpdateSQL_Read_DeleteSQL, 0, [0], varEmpty);
