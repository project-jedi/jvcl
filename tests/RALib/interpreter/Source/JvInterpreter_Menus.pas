...
procedure JvInterpreter_ShortCut(var Value: Variant; Args: TArgs);
begin 
  Value := ShortCut(Args.Values[0], TShiftState(Byte(V2S(Args.Values[1]))));
end;

{ procedure ShortCutToKey(ShortCut: TShortCut; var Key: Word; var Shift: TShiftState); }
procedure JvInterpreter_ShortCutToKey(var Value: Variant; Args: TArgs);
var
  Shift: TShiftState;
begin
...
procedure JvInterpreter_ShortCutToText(var Value: Variant; Args: TArgs);
begin
  Value := ShortCutToText(Args.Values[0]);
end;

{ function TextToShortCut(Text: string): TShortCut; }
procedure JvInterpreter_TextToShortCut(var Value: Variant; Args: TArgs);
begin
...
procedure JvInterpreter_NewMenu(var Value: Variant; Args: TArgs);
begin
...
procedure JvInterpreter_NewPopupMenu(var Value: Variant; Args: TArgs);
begin
...
procedure JvInterpreter_NewSubMenu(var Value: Variant; Args: TArgs);
begin
...
procedure JvInterpreter_NewItem(var Value: Variant; Args: TArgs);
begin
  Value := O2V(NewItem(Args.Values[0], Args.Values[1], Args.Values[2], Args.Values[3], nil, Args.Values[5], Args.Values[6]));
end;

{ function NewLine: TMenuItem; }
procedure JvInterpreter_NewLine(var Value: Variant; Args: TArgs);
begin
  Value := O2V(NewLine);
end;
...
begin
  ...
  begin
   ...
   { TMenuItem }
    ...
    AddGet(TMenuItem, 'Click', TMenuItem_Click, 0, [0], varEmpty);
    ...
    AddGet(TMenuItem, 'Command', TMenuItem_Read_Command, 0, [0], varEmpty);
    AddGet(TMenuItem, 'Handle', TMenuItem_Read_Handle, 0, [0], varEmpty);
    AddGet(TMenuItem, 'Count', TMenuItem_Read_Count, 0, [0], varEmpty);
    AddIGet(TMenuItem, 'Items', TMenuItem_Read_Items, 1, [0], varEmpty);
    AddGet(TMenuItem, 'MenuIndex', TMenuItem_Read_MenuIndex, 0, [0], varEmpty);
    AddSet(TMenuItem, 'MenuIndex', TMenuItem_Write_MenuIndex, 0, [0]);
    AddGet(TMenuItem, 'Parent', TMenuItem_Read_Parent, 0, [0], varEmpty);
    AddGet(TMenuItem, 'Break', TMenuItem_Read_Break, 0, [0], varEmpty);
    AddSet(TMenuItem, 'Break', TMenuItem_Write_Break, 0, [0]);
    AddGet(TMenuItem, 'Caption', TMenuItem_Read_Caption, 0, [0], varEmpty);
    AddSet(TMenuItem, 'Caption', TMenuItem_Write_Caption, 0, [0]);
    AddGet(TMenuItem, 'Checked', TMenuItem_Read_Checked, 0, [0], varEmpty);
    AddSet(TMenuItem, 'Checked', TMenuItem_Write_Checked, 0, [0]);
    AddGet(TMenuItem, 'Default', TMenuItem_Read_Default, 0, [0], varEmpty);
    AddSet(TMenuItem, 'Default', TMenuItem_Write_Default, 0, [0]);
    AddGet(TMenuItem, 'Enabled', TMenuItem_Read_Enabled, 0, [0], varEmpty);
    AddSet(TMenuItem, 'Enabled', TMenuItem_Write_Enabled, 0, [0]);
    AddGet(TMenuItem, 'GroupIndex', TMenuItem_Read_GroupIndex, 0, [0], varEmpty);
    AddSet(TMenuItem, 'GroupIndex', TMenuItem_Write_GroupIndex, 0, [0]);
    AddGet(TMenuItem, 'HelpContext', TMenuItem_Read_HelpContext, 0, [0], varEmpty);
    AddSet(TMenuItem, 'HelpContext', TMenuItem_Write_HelpContext, 0, [0]);
    AddGet(TMenuItem, 'Hint', TMenuItem_Read_Hint, 0, [0], varEmpty);
    AddSet(TMenuItem, 'Hint', TMenuItem_Write_Hint, 0, [0]);
    AddGet(TMenuItem, 'RadioItem', TMenuItem_Read_RadioItem, 0, [0], varEmpty);
    AddSet(TMenuItem, 'RadioItem', TMenuItem_Write_RadioItem, 0, [0]);
    AddGet(TMenuItem, 'ShortCut', TMenuItem_Read_ShortCut, 0, [0], varEmpty);
    AddSet(TMenuItem, 'ShortCut', TMenuItem_Write_ShortCut, 0, [0]);
    AddGet(TMenuItem, 'Visible', TMenuItem_Read_Visible, 0, [0], varEmpty);
   ...
   // AddGet(TMenu, 'IsShortCut', TMenu_IsShortCut, 1, [varByRef], nil);
    AddGet(TMenu, 'Handle', TMenu_Read_Handle, 0, [0], varEmpty);
    AddGet(TMenu, 'WindowHandle', TMenu_Read_WindowHandle, 0, [0], varEmpty);
    AddSet(TMenu, 'WindowHandle', TMenu_Write_WindowHandle, 0, [0]);
    AddGet(TMenu, 'Items', TMenu_Read_Items, 0, [0], varEmpty);
   { TMainMenu }
    ...
    AddGet(TMainMenu, 'AutoMerge', TMainMenu_Read_AutoMerge, 0, [0], varEmpty);
   ...
   { TPopupMenu }
    ...
    AddGet(TPopupMenu, 'PopupComponent', TPopupMenu_Read_PopupComponent, 0, [0], varEmpty);
    AddSet(TPopupMenu, 'PopupComponent', TPopupMenu_Write_PopupComponent, 0, [0]);
    AddGet(TPopupMenu, 'Alignment', TPopupMenu_Read_Alignment, 0, [0], varEmpty);
    AddSet(TPopupMenu, 'Alignment', TPopupMenu_Write_Alignment, 0, [0]);
    AddGet(TPopupMenu, 'AutoPopup', TPopupMenu_Read_AutoPopup, 0, [0], varEmpty);
    ...
    AddFun('Menus', 'ShortCut', JvInterpreter_ShortCut, 2, [varEmpty, varEmpty], varEmpty);
    AddFun('Menus', 'ShortCutToKey', JvInterpreter_ShortCutToKey, 3, [varEmpty, varByRef, varByRef], varEmpty);
    AddFun('Menus', 'ShortCutToText', JvInterpreter_ShortCutToText, 1, [varEmpty], varEmpty);
    AddFun('Menus', 'TextToShortCut', JvInterpreter_TextToShortCut, 1, [varEmpty], varEmpty);
   { AddFun('Menus', 'NewMenu', JvInterpreter_NewMenu, 3, [varEmpty, varEmpty, varEmpty], nil);
    AddFun('Menus', 'NewPopupMenu', JvInterpreter_NewPopupMenu, 5, [varEmpty, varEmpty, varEmpty, varEmpty, varEmpty], varEmpty);
    AddFun('Menus', 'NewSubMenu', JvInterpreter_NewSubMenu, 4, [varEmpty, varEmpty, varEmpty, varEmpty], varEmpty); }
    AddFun('Menus', 'NewItem', JvInterpreter_NewItem, 7, [varEmpty, varEmpty, varEmpty, varEmpty, varEmpty, varEmpty, varEmpty], varEmpty);
    AddFun('Menus', 'NewLine', JvInterpreter_NewLine, 0, [0], varEmpty);
  end;    { with }
