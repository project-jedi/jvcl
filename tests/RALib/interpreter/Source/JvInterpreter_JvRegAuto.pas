...
procedure TRegAuto_Read_UseReg(var Value: Variant; Args: TArgs);
begin
  Value := TJvRegAuto(Args.Obj).UseReg;
end;

{ property Write UseReg(Value: Boolean) }
procedure TRegAuto_Write_UseReg(const Value: Variant; Args: TArgs);
begin
  TJvRegAuto(Args.Obj).UseReg := Value;
end;

{ property Read UseIni: Boolean }
procedure TRegAuto_Read_UseIni(var Value: Variant; Args: TArgs);
begin
  Value := TJvRegAuto(Args.Obj).UseIni;
end;

{ property Write UseIni(Value: Boolean) }
procedure TRegAuto_Write_UseIni(const Value: Variant; Args: TArgs);
begin
  TJvRegAuto(Args.Obj).UseIni := Value;
end;

{ property Read UseStr: Boolean }
procedure TRegAuto_Read_UseStr(var Value: Variant; Args: TArgs);
begin
  Value := TJvRegAuto(Args.Obj).UseStr;
end;

{ property Write UseStr(Value: Boolean) }
procedure TRegAuto_Write_UseStr(const Value: Variant; Args: TArgs);
begin
...
begin
  ...
  begin
   { TJvRegAuto }
    AddClass('JvRegAuto', TJvRegAuto, 'TJvRegAuto');
