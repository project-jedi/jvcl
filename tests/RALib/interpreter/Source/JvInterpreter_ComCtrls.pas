...
uses Windows, Classes, Controls, ComCtrls, Graphics, JvInterpreter_Windows;
...
procedure TJvInterpreterComCtrlsEvent.DrawSectionEvent(HeaderControl: THeaderControl; Section: THeaderSection; const Rect: TRect; Pressed: Boolean);
begin
...
procedure TJvInterpreterComCtrlsEvent.SectionTrackEvent(HeaderControl: THeaderControl; Section: THeaderSection; Width: Integer; State: TSectionTrackState);
begin
...
procedure TJvInterpreterComCtrlsEvent.TVCompareEvent(Sender: TObject; Node1, Node2: TTreeNode; Data: Integer; var Compare: Integer);
begin
...
procedure TJvInterpreterComCtrlsEvent.RichEditProtectChange(Sender: TObject; StartPos, EndPos: Integer; var AllowChange: Boolean);
begin
  CallFunction(nil, [O2V(Sender), StartPos, EndPos, AllowChange]);
  AllowChange := Args.Values[3];
end;

procedure TJvInterpreterComCtrlsEvent.RichEditSaveClipboard(Sender: TObject; NumObjects, NumChars: Integer; var SaveClipboard: Boolean);
begin
...
procedure TJvInterpreterComCtrlsEvent.LVChangingEvent(Sender: TObject; Item: TListItem; Change: TItemChange; var AllowChange: Boolean);
begin
...
procedure TJvInterpreterComCtrlsEvent.LVCompareEvent(Sender: TObject; Item1, Item2: TListItem; Data: Integer; var Compare: Integer);
begin
...
begin
  ...
  begin
   ...
   { TTabSheet }
    ...
    AddGet(TTabSheet, 'PageControl', TTabSheet_Read_PageControl, 0, [0], varEmpty);
    AddSet(TTabSheet, 'PageControl', TTabSheet_Write_PageControl, 0, [0]);
    AddGet(TTabSheet, 'TabIndex', TTabSheet_Read_TabIndex, 0, [0], varEmpty);
   { TPageControl }
   ...
   { TStatusPanels }
    ...
    AddGet(TStatusPanels, 'Add', TStatusPanels_Add, 0, [0], varEmpty);
    AddIGet(TStatusPanels, 'Items', TStatusPanels_Read_Items, 1, [0], varEmpty);
    AddISet(TStatusPanels, 'Items', TStatusPanels_Write_Items, 1, [1]);
   { TStatusBar }
   ...
   { THeaderSection }
    ...
    AddGet(THeaderSection, 'Left', THeaderSection_Read_Left, 0, [0], varEmpty);
    AddGet(THeaderSection, 'Right', THeaderSection_Read_Right, 0, [0], varEmpty);
   { THeaderSections }
    ...
    AddGet(THeaderSections, 'Add', THeaderSections_Add, 0, [0], varEmpty);
   ...
   { TTreeNode }
    ...
    AddGet(TTreeNode, 'AlphaSort', TTreeNode_AlphaSort, 0, [0], varEmpty);
    ...
    AddGet(TTreeNode, 'Delete', TTreeNode_Delete, 0, [0], varEmpty);
    AddGet(TTreeNode, 'DeleteChildren', TTreeNode_DeleteChildren, 0, [0], varEmpty);
    AddGet(TTreeNode, 'DisplayRect', TTreeNode_DisplayRect, 1, [varEmpty], varEmpty);
    AddGet(TTreeNode, 'EditText', TTreeNode_EditText, 0, [0], varEmpty);
    ...
    AddGet(TTreeNode, 'GetFirstChild', TTreeNode_GetFirstChild, 0, [0], varEmpty);
    AddGet(TTreeNode, 'GetHandle', TTreeNode_GetHandle, 0, [0], varEmpty);
    AddGet(TTreeNode, 'GetLastChild', TTreeNode_GetLastChild, 0, [0], varEmpty);
    AddGet(TTreeNode, 'GetNext', TTreeNode_GetNext, 0, [0], varEmpty);
    AddGet(TTreeNode, 'GetNextChild', TTreeNode_GetNextChild, 1, [varEmpty], varEmpty);
    AddGet(TTreeNode, 'GetNextSibling', TTreeNode_GetNextSibling, 0, [0], varEmpty);
    AddGet(TTreeNode, 'GetNextVisible', TTreeNode_GetNextVisible, 0, [0], varEmpty);
    AddGet(TTreeNode, 'GetPrev', TTreeNode_GetPrev, 0, [0], varEmpty);
    AddGet(TTreeNode, 'GetPrevChild', TTreeNode_GetPrevChild, 1, [varEmpty], varEmpty);
    AddGet(TTreeNode, 'GetPrevSibling', TTreeNode_GetPrevSibling, 0, [0], varEmpty);
    AddGet(TTreeNode, 'GetPrevVisible', TTreeNode_GetPrevVisible, 0, [0], varEmpty);
    ...
    AddGet(TTreeNode, 'MakeVisible', TTreeNode_MakeVisible, 0, [0], varEmpty);
    AddGet(TTreeNode, 'MoveTo', TTreeNode_MoveTo, 2, [varEmpty, varEmpty], varEmpty);
    AddGet(TTreeNode, 'AbsoluteIndex', TTreeNode_Read_AbsoluteIndex, 0, [0], varEmpty);
    AddGet(TTreeNode, 'Count', TTreeNode_Read_Count, 0, [0], varEmpty);
    AddGet(TTreeNode, 'Cut', TTreeNode_Read_Cut, 0, [0], varEmpty);
    AddSet(TTreeNode, 'Cut', TTreeNode_Write_Cut, 0, [0]);
    AddGet(TTreeNode, 'Data', TTreeNode_Read_Data, 0, [0], varEmpty);
    AddSet(TTreeNode, 'Data', TTreeNode_Write_Data, 0, [0]);
    AddGet(TTreeNode, 'Deleting', TTreeNode_Read_Deleting, 0, [0], varEmpty);
    AddGet(TTreeNode, 'Focused', TTreeNode_Read_Focused, 0, [0], varEmpty);
    AddSet(TTreeNode, 'Focused', TTreeNode_Write_Focused, 0, [0]);
    AddGet(TTreeNode, 'DropTarget', TTreeNode_Read_DropTarget, 0, [0], varEmpty);
    AddSet(TTreeNode, 'DropTarget', TTreeNode_Write_DropTarget, 0, [0]);
    AddGet(TTreeNode, 'Selected', TTreeNode_Read_Selected, 0, [0], varEmpty);
    AddSet(TTreeNode, 'Selected', TTreeNode_Write_Selected, 0, [0]);
    AddGet(TTreeNode, 'Expanded', TTreeNode_Read_Expanded, 0, [0], varEmpty);
    AddSet(TTreeNode, 'Expanded', TTreeNode_Write_Expanded, 0, [0]);
    AddGet(TTreeNode, 'Handle', TTreeNode_Read_Handle, 0, [0], varEmpty);
    AddGet(TTreeNode, 'HasChildren', TTreeNode_Read_HasChildren, 0, [0], varEmpty);
    AddSet(TTreeNode, 'HasChildren', TTreeNode_Write_HasChildren, 0, [0]);
    AddGet(TTreeNode, 'ImageIndex', TTreeNode_Read_ImageIndex, 0, [0], varEmpty);
    AddSet(TTreeNode, 'ImageIndex', TTreeNode_Write_ImageIndex, 0, [0]);
    AddGet(TTreeNode, 'Index', TTreeNode_Read_Index, 0, [0], varEmpty);
    AddGet(TTreeNode, 'IsVisible', TTreeNode_Read_IsVisible, 0, [0], varEmpty);
    AddIGet(TTreeNode, 'Item', TTreeNode_Read_Item, 1, [0], varEmpty);
    AddISet(TTreeNode, 'Item', TTreeNode_Write_Item, 1, [1]);
    AddGet(TTreeNode, 'ItemId', TTreeNode_Read_ItemId, 0, [0], varEmpty);
    AddGet(TTreeNode, 'Level', TTreeNode_Read_Level, 0, [0], varEmpty);
    AddGet(TTreeNode, 'OverlayIndex', TTreeNode_Read_OverlayIndex, 0, [0], varEmpty);
    AddSet(TTreeNode, 'OverlayIndex', TTreeNode_Write_OverlayIndex, 0, [0]);
    AddGet(TTreeNode, 'Owner', TTreeNode_Read_Owner, 0, [0], varEmpty);
    AddGet(TTreeNode, 'Parent', TTreeNode_Read_Parent, 0, [0], varEmpty);
    AddGet(TTreeNode, 'SelectedIndex', TTreeNode_Read_SelectedIndex, 0, [0], varEmpty);
    AddSet(TTreeNode, 'SelectedIndex', TTreeNode_Write_SelectedIndex, 0, [0]);
    AddGet(TTreeNode, 'StateIndex', TTreeNode_Read_StateIndex, 0, [0], varEmpty);
    AddSet(TTreeNode, 'StateIndex', TTreeNode_Write_StateIndex, 0, [0]);
    AddGet(TTreeNode, 'Text', TTreeNode_Read_Text, 0, [0], varEmpty);
    AddSet(TTreeNode, 'Text', TTreeNode_Write_Text, 0, [0]);
    AddGet(TTreeNode, 'TreeView', TTreeNode_Read_TreeView, 0, [0], varEmpty);
   { TTreeNodes }
    ...
    AddGet(TTreeNodes, 'AddChildObjectFirst', TTreeNodes_AddChildObjectFirst, 3, [varEmpty, varEmpty, varEmpty], varEmpty);
    ...
    AddGet(TTreeNodes, 'BeginUpdate', TTreeNodes_BeginUpdate, 0, [0], varEmpty);
    AddGet(TTreeNodes, 'Clear', TTreeNodes_Clear, 0, [0], varEmpty);
    AddGet(TTreeNodes, 'Delete', TTreeNodes_Delete, 1, [varEmpty], varEmpty);
    AddGet(TTreeNodes, 'EndUpdate', TTreeNodes_EndUpdate, 0, [0], varEmpty);
    AddGet(TTreeNodes, 'GetFirstNode', TTreeNodes_GetFirstNode, 0, [0], varEmpty);
    ...
    AddGet(TTreeNodes, 'Count', TTreeNodes_Read_Count, 0, [0], varEmpty);
    AddGet(TTreeNodes, 'Handle', TTreeNodes_Read_Handle, 0, [0], varEmpty);
   ...
   { TCustomTreeView }
    ...
    AddGet(TCustomTreeView, 'FullCollapse', TCustomTreeView_FullCollapse, 0, [0], varEmpty);
    AddGet(TCustomTreeView, 'FullExpand', TCustomTreeView_FullExpand, 0, [0], varEmpty);
    ...
    AddGet(TCustomTreeView, 'IsEditing', TCustomTreeView_IsEditing, 0, [0], varEmpty);
    ...
    AddGet(TCustomTreeView, 'DropTarget', TCustomTreeView_Read_DropTarget, 0, [0], varEmpty);
    AddSet(TCustomTreeView, 'DropTarget', TCustomTreeView_Write_DropTarget, 0, [0]);
    AddGet(TCustomTreeView, 'Selected', TCustomTreeView_Read_Selected, 0, [0], varEmpty);
    AddSet(TCustomTreeView, 'Selected', TCustomTreeView_Write_Selected, 0, [0]);
    AddGet(TCustomTreeView, 'TopItem', TCustomTreeView_Read_TopItem, 0, [0], varEmpty);
   ...
   {$ENDIF COMPILER3_UP}
    ...
    AddGet(TTextAttributes, 'Name', TTextAttributes_Read_Name, 0, [0], varEmpty);
    AddSet(TTextAttributes, 'Name', TTextAttributes_Write_Name, 0, [0]);
    AddGet(TTextAttributes, 'Pitch', TTextAttributes_Read_Pitch, 0, [0], varEmpty);
    AddSet(TTextAttributes, 'Pitch', TTextAttributes_Write_Pitch, 0, [0]);
    AddGet(TTextAttributes, 'Protected', TTextAttributes_Read_Protected, 0, [0], varEmpty);
    AddSet(TTextAttributes, 'Protected', TTextAttributes_Write_Protected, 0, [0]);
    AddGet(TTextAttributes, 'Size', TTextAttributes_Read_Size, 0, [0], varEmpty);
    AddSet(TTextAttributes, 'Size', TTextAttributes_Write_Size, 0, [0]);
    AddGet(TTextAttributes, 'Style', TTextAttributes_Read_Style, 0, [0], varEmpty);
   ...
   { TParaAttributes }
    ...
    AddGet(TParaAttributes, 'Alignment', TParaAttributes_Read_Alignment, 0, [0], varEmpty);
    AddSet(TParaAttributes, 'Alignment', TParaAttributes_Write_Alignment, 0, [0]);
    AddGet(TParaAttributes, 'FirstIndent', TParaAttributes_Read_FirstIndent, 0, [0], varEmpty);
    AddSet(TParaAttributes, 'FirstIndent', TParaAttributes_Write_FirstIndent, 0, [0]);
    AddGet(TParaAttributes, 'LeftIndent', TParaAttributes_Read_LeftIndent, 0, [0], varEmpty);
    AddSet(TParaAttributes, 'LeftIndent', TParaAttributes_Write_LeftIndent, 0, [0]);
    AddGet(TParaAttributes, 'Numbering', TParaAttributes_Read_Numbering, 0, [0], varEmpty);
    AddSet(TParaAttributes, 'Numbering', TParaAttributes_Write_Numbering, 0, [0]);
    AddGet(TParaAttributes, 'RightIndent', TParaAttributes_Read_RightIndent, 0, [0], varEmpty);
    AddSet(TParaAttributes, 'RightIndent', TParaAttributes_Write_RightIndent, 0, [0]);
    AddGet(TParaAttributes, 'Tab', TParaAttributes_Read_Tab, 1, [0], varEmpty);
   ...
   { TCustomRichEdit }
    ...
    AddGet(TCustomRichEdit, 'FindText', TCustomRichEdit_FindText, 4, [varEmpty, varEmpty, varEmpty, varEmpty], varEmpty);
    ...
    AddGet(TCustomRichEdit, 'DefAttributes', TCustomRichEdit_Read_DefAttributes, 0, [0], varEmpty);
    AddSet(TCustomRichEdit, 'DefAttributes', TCustomRichEdit_Write_DefAttributes, 0, [0]);
    AddGet(TCustomRichEdit, 'SelAttributes', TCustomRichEdit_Read_SelAttributes, 0, [0], varEmpty);
    AddSet(TCustomRichEdit, 'SelAttributes', TCustomRichEdit_Write_SelAttributes, 0, [0]);
    AddGet(TCustomRichEdit, 'PageRect', TCustomRichEdit_Read_PageRect, 0, [0], varEmpty);
    AddSet(TCustomRichEdit, 'PageRect', TCustomRichEdit_Write_PageRect, 0, [0]);
    AddGet(TCustomRichEdit, 'Paragraph', TCustomRichEdit_Read_Paragraph, 0, [0], varEmpty);
   { TRichEdit }
   ...
   { TListColumn }
    ...
    AddGet(TListColumn, 'WidthType', TListColumn_Read_WidthType, 0, [0], varEmpty);
   { TListColumns }
    AddClass('ComCtrls', TListColumns, 'TListColumns');
    AddGet(TListColumns, 'Create', TListColumns_Create, 1, [varEmpty], varEmpty);
    AddGet(TListColumns, 'Add', TListColumns_Add, 0, [0], varEmpty);
    AddGet(TListColumns, 'Owner', TListColumns_Read_Owner, 0, [0], varEmpty);
   ...
   { TListItem }
    ...
    AddGet(TListItem, 'CancelEdit', TListItem_CancelEdit, 0, [0], varEmpty);
    AddGet(TListItem, 'Delete', TListItem_Delete, 0, [0], varEmpty);
    AddGet(TListItem, 'DisplayRect', TListItem_DisplayRect, 1, [varEmpty], varEmpty);
    AddGet(TListItem, 'EditCaption', TListItem_EditCaption, 0, [0], varEmpty);
    AddGet(TListItem, 'GetPosition', TListItem_GetPosition, 0, [0], varEmpty);
    AddGet(TListItem, 'MakeVisible', TListItem_MakeVisible, 1, [varEmpty], varEmpty);
    AddGet(TListItem, 'Update', TListItem_Update, 0, [0], varEmpty);
   ...
   {$ENDIF COMPILER3_UP}
    ...
    AddGet(TListItem, 'DropTarget', TListItem_Read_DropTarget, 0, [0], varEmpty);
    AddSet(TListItem, 'DropTarget', TListItem_Write_DropTarget, 0, [0]);
    AddGet(TListItem, 'Focused', TListItem_Read_Focused, 0, [0], varEmpty);
    AddSet(TListItem, 'Focused', TListItem_Write_Focused, 0, [0]);
    AddGet(TListItem, 'Handle', TListItem_Read_Handle, 0, [0], varEmpty);
    AddGet(TListItem, 'ImageIndex', TListItem_Read_ImageIndex, 0, [0], varEmpty);
    AddSet(TListItem, 'ImageIndex', TListItem_Write_ImageIndex, 0, [0]);
    AddGet(TListItem, 'Index', TListItem_Read_Index, 0, [0], varEmpty);
    AddGet(TListItem, 'Left', TListItem_Read_Left, 0, [0], varEmpty);
    AddSet(TListItem, 'Left', TListItem_Write_Left, 0, [0]);
    AddGet(TListItem, 'ListView', TListItem_Read_ListView, 0, [0], varEmpty);
    AddGet(TListItem, 'Owner', TListItem_Read_Owner, 0, [0], varEmpty);
    AddGet(TListItem, 'OverlayIndex', TListItem_Read_OverlayIndex, 0, [0], varEmpty);
    AddSet(TListItem, 'OverlayIndex', TListItem_Write_OverlayIndex, 0, [0]);
    AddGet(TListItem, 'Selected', TListItem_Read_Selected, 0, [0], varEmpty);
    AddSet(TListItem, 'Selected', TListItem_Write_Selected, 0, [0]);
    AddGet(TListItem, 'StateIndex', TListItem_Read_StateIndex, 0, [0], varEmpty);
    AddSet(TListItem, 'StateIndex', TListItem_Write_StateIndex, 0, [0]);
    AddIGet(TListItem, 'SubItems', TListItem_Read_SubItems, 0, [0], varEmpty);
    AddISet(TListItem, 'SubItems', TListItem_Write_SubItems, 0, [0]);
    AddGet(TListItem, 'Top', TListItem_Read_Top, 0, [0], varEmpty);
   ...
   { TListItems }
    ...
    AddGet(TListItems, 'Add', TListItems_Add, 0, [0], varEmpty);
    AddGet(TListItems, 'Assign', TListItems_Assign, 1, [varEmpty], varEmpty);
    AddGet(TListItems, 'BeginUpdate', TListItems_BeginUpdate, 0, [0], varEmpty);
    AddGet(TListItems, 'Clear', TListItems_Clear, 0, [0], varEmpty);
    AddGet(TListItems, 'Delete', TListItems_Delete, 1, [varEmpty], varEmpty);
    AddGet(TListItems, 'EndUpdate', TListItems_EndUpdate, 0, [0], varEmpty);
    ...
    AddGet(TListItems, 'Count', TListItems_Read_Count, 0, [0], varEmpty);
    AddGet(TListItems, 'Handle', TListItems_Read_Handle, 0, [0], varEmpty);
    AddIGet(TListItems, 'Item', TListItems_Read_Item, 1, [0], varEmpty);
   ...
   { TCustomListView }
    ...
    AddGet(TCustomListView, 'FindCaption', TCustomListView_FindCaption, 5, [varEmpty, varEmpty, varEmpty, varEmpty, varEmpty], varEmpty);
    AddGet(TCustomListView, 'FindData', TCustomListView_FindData, 4, [varEmpty, varEmpty, varEmpty, varEmpty], varEmpty);
   ...
   {$ENDIF COMPILER3_UP}
    ...
    AddGet(TCustomListView, 'TopItem', TCustomListView_Read_TopItem, 0, [0], varEmpty);
    AddGet(TCustomListView, 'ViewOrigin', TCustomListView_Read_ViewOrigin, 0, [0], varEmpty);
    AddGet(TCustomListView, 'VisibleRowCount', TCustomListView_Read_VisibleRowCount, 0, [0], varEmpty);
    AddGet(TCustomListView, 'BoundingRect', TCustomListView_Read_BoundingRect, 0, [0], varEmpty);
   { TListView }
   ...
   { TAnimate }
    ...
    AddGet(TAnimate, 'FrameCount', TAnimate_Read_FrameCount, 0, [0], varEmpty);
    AddGet(TAnimate, 'FrameHeight', TAnimate_Read_FrameHeight, 0, [0], varEmpty);
    AddGet(TAnimate, 'FrameWidth', TAnimate_Read_FrameWidth, 0, [0], varEmpty);
    AddGet(TAnimate, 'Open', TAnimate_Read_Open, 0, [0], varEmpty);
    AddSet(TAnimate, 'Open', TAnimate_Write_Open, 0, [0]);
    AddGet(TAnimate, 'Play', TAnimate_Play, 3, [varEmpty, varEmpty, varEmpty], varEmpty);
    AddGet(TAnimate, 'Reset', TAnimate_Reset, 0, [0], varEmpty);
    AddGet(TAnimate, 'Seek', TAnimate_Seek, 1, [varEmpty], varEmpty);
    AddGet(TAnimate, 'Stop', TAnimate_Stop, 0, [0], varEmpty);
    AddGet(TAnimate, 'ResHandle', TAnimate_Read_ResHandle, 0, [0], varEmpty);
    AddSet(TAnimate, 'ResHandle', TAnimate_Write_ResHandle, 0, [0]);
    AddGet(TAnimate, 'ResId', TAnimate_Read_ResId, 0, [0], varEmpty);
   ...
   {$ENDIF COMPILER3_UP}
    ...
    AddHandler('ComCtrls', 'TDrawSectionEvent', TJvInterpreterComCtrlsEvent, @TJvInterpreterComCtrlsEvent.DrawSectionEvent);
    AddHandler('ComCtrls', 'TSectionNotifyEvent', TJvInterpreterComCtrlsEvent, @TJvInterpreterComCtrlsEvent.SectionNotifyEvent);
    AddHandler('ComCtrls', 'TSectionTrackEvent', TJvInterpreterComCtrlsEvent, @TJvInterpreterComCtrlsEvent.SectionTrackEvent);
    AddHandler('ComCtrls', 'TTVChangingEvent', TJvInterpreterComCtrlsEvent, @TJvInterpreterComCtrlsEvent.TVChangingEvent);
    AddHandler('ComCtrls', 'TTVChangedEvent', TJvInterpreterComCtrlsEvent, @TJvInterpreterComCtrlsEvent.TVChangedEvent);
    AddHandler('ComCtrls', 'TTVEditingEvent', TJvInterpreterComCtrlsEvent, @TJvInterpreterComCtrlsEvent.TVEditingEvent);
    AddHandler('ComCtrls', 'TTVEditedEvent', TJvInterpreterComCtrlsEvent, @TJvInterpreterComCtrlsEvent.TVEditedEvent);
    AddHandler('ComCtrls', 'TTVExpandingEvent', TJvInterpreterComCtrlsEvent, @TJvInterpreterComCtrlsEvent.TVExpandingEvent);
    AddHandler('ComCtrls', 'TTVCollapsingEvent', TJvInterpreterComCtrlsEvent, @TJvInterpreterComCtrlsEvent.TVCollapsingEvent);
    AddHandler('ComCtrls', 'TTVExpandedEvent', TJvInterpreterComCtrlsEvent, @TJvInterpreterComCtrlsEvent.TVExpandedEvent);
    AddHandler('ComCtrls', 'TTVCompareEvent', TJvInterpreterComCtrlsEvent, @TJvInterpreterComCtrlsEvent.TVCompareEvent);
    AddHandler('ComCtrls', 'TRichEditResizeEvent', TJvInterpreterComCtrlsEvent, @TJvInterpreterComCtrlsEvent.RichEditResizeEvent);
    AddHandler('ComCtrls', 'TRichEditProtectChange', TJvInterpreterComCtrlsEvent, @TJvInterpreterComCtrlsEvent.RichEditProtectChange);
    AddHandler('ComCtrls', 'TRichEditSaveClipboard', TJvInterpreterComCtrlsEvent, @TJvInterpreterComCtrlsEvent.RichEditSaveClipboard);
    AddHandler('ComCtrls', 'TUDClickEvent', TJvInterpreterComCtrlsEvent, @TJvInterpreterComCtrlsEvent.UDClickEvent);
    AddHandler('ComCtrls', 'TUDChangingEvent', TJvInterpreterComCtrlsEvent, @TJvInterpreterComCtrlsEvent.UDChangingEvent);
    AddHandler('ComCtrls', 'TLVDeletedEvent', TJvInterpreterComCtrlsEvent, @TJvInterpreterComCtrlsEvent.LVDeletedEvent);
    AddHandler('ComCtrls', 'TLVEditingEvent', TJvInterpreterComCtrlsEvent, @TJvInterpreterComCtrlsEvent.LVEditingEvent);
    AddHandler('ComCtrls', 'TLVEditedEvent', TJvInterpreterComCtrlsEvent, @TJvInterpreterComCtrlsEvent.LVEditedEvent);
    AddHandler('ComCtrls', 'TLVChangeEvent', TJvInterpreterComCtrlsEvent, @TJvInterpreterComCtrlsEvent.LVChangeEvent);
    AddHandler('ComCtrls', 'TLVChangingEvent', TJvInterpreterComCtrlsEvent, @TJvInterpreterComCtrlsEvent.LVChangingEvent);
    AddHandler('ComCtrls', 'TLVColumnClickEvent', TJvInterpreterComCtrlsEvent, @TJvInterpreterComCtrlsEvent.LVColumnClickEvent);
    AddHandler('ComCtrls', 'TLVCompareEvent', TJvInterpreterComCtrlsEvent, @TJvInterpreterComCtrlsEvent.LVCompareEvent);
  end;    { with }
