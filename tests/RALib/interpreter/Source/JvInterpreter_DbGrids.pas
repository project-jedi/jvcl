...
uses Classes, Graphics, Menus, Grids, Db, DbGrids, JvInterpreter_Windows;
...
begin
  ...
  begin
   ...
   { TColumnTitle }
    ...
    AddGet(TColumnTitle, 'DefaultAlignment', TColumnTitle_DefaultAlignment, 0, [0], varEmpty);
    AddGet(TColumnTitle, 'DefaultColor', TColumnTitle_DefaultColor, 0, [0], varEmpty);
    AddGet(TColumnTitle, 'DefaultFont', TColumnTitle_DefaultFont, 0, [0], varEmpty);
    AddGet(TColumnTitle, 'DefaultCaption', TColumnTitle_DefaultCaption, 0, [0], varEmpty);
    AddGet(TColumnTitle, 'RestoreDefaults', TColumnTitle_RestoreDefaults, 0, [0], varEmpty);
    AddGet(TColumnTitle, 'Alignment', TColumnTitle_Read_Alignment, 0, [0], varEmpty);
    AddSet(TColumnTitle, 'Alignment', TColumnTitle_Write_Alignment, 0, [0]);
    AddGet(TColumnTitle, 'Caption', TColumnTitle_Read_Caption, 0, [0], varEmpty);
    AddSet(TColumnTitle, 'Caption', TColumnTitle_Write_Caption, 0, [0]);
    AddGet(TColumnTitle, 'Color', TColumnTitle_Read_Color, 0, [0], varEmpty);
   ...
   {$ENDIF COMPILER3_UP}
    ...
    AddGet(TColumn, 'Alignment', TColumn_Read_Alignment, 0, [0], varEmpty);
    AddSet(TColumn, 'Alignment', TColumn_Write_Alignment, 0, [0]);
    AddGet(TColumn, 'ButtonStyle', TColumn_Read_ButtonStyle, 0, [0], varEmpty);
    AddSet(TColumn, 'ButtonStyle', TColumn_Write_ButtonStyle, 0, [0]);
    AddGet(TColumn, 'Color', TColumn_Read_Color, 0, [0], varEmpty);
    AddSet(TColumn, 'Color', TColumn_Write_Color, 0, [0]);
    AddGet(TColumn, 'DropDownRows', TColumn_Read_DropDownRows, 0, [0], varEmpty);
    AddSet(TColumn, 'DropDownRows', TColumn_Write_DropDownRows, 0, [0]);
    AddGet(TColumn, 'FieldName', TColumn_Read_FieldName, 0, [0], varEmpty);
   ...
   {$ENDIF COMPILER3_UP}
    ...
    AddIGet(TDBGridColumns, 'Items', TDBGridColumns_Read_Items, 1, [0], varEmpty);
    AddISet(TDBGridColumns, 'Items', TDBGridColumns_Write_Items, 1, [1]);
    AddIDGet(TDBGridColumns, TDBGridColumns_Read_Items, 1, [0], varEmpty);
    AddIDSet(TDBGridColumns, TDBGridColumns_Write_Items, 1, [1]);
   { TBookmarkList }
    AddClass('DbGrids', TBookmarkList, 'TBookmarkList');
    AddGet(TBookmarkList, 'Create', TBookmarkList_Create, 1, [varEmpty], varEmpty);
    AddGet(TBookmarkList, 'Clear', TBookmarkList_Clear, 0, [0], varEmpty);
    AddGet(TBookmarkList, 'Delete', TBookmarkList_Delete, 0, [0], varEmpty);
    ...
    AddGet(TBookmarkList, 'Refresh', TBookmarkList_Refresh, 0, [0], varEmpty);
    AddGet(TBookmarkList, 'Count', TBookmarkList_Read_Count, 0, [0], varEmpty);
    AddGet(TBookmarkList, 'CurrentRowSelected', TBookmarkList_Read_CurrentRowSelected, 0, [0], varEmpty);
   ...
   { TCustomDBGrid }
    ...
    AddGet(TCustomDBGrid, 'DefaultDrawDataCell', TCustomDBGrid_DefaultDrawDataCell, 3, [varEmpty, varEmpty, varEmpty], varEmpty);
    AddGet(TCustomDBGrid, 'DefaultDrawColumnCell', TCustomDBGrid_DefaultDrawColumnCell, 4, [varEmpty, varEmpty, varEmpty, varEmpty], varEmpty);
    AddGet(TCustomDBGrid, 'ValidFieldIndex', TCustomDBGrid_ValidFieldIndex, 1, [varEmpty], varEmpty);
    AddGet(TCustomDBGrid, 'FieldCount', TCustomDBGrid_Read_FieldCount, 0, [0], varEmpty);
    AddIGet(TCustomDBGrid, 'Fields', TCustomDBGrid_Read_Fields, 1, [0], varEmpty);
    AddGet(TCustomDBGrid, 'SelectedField', TCustomDBGrid_Read_SelectedField, 0, [0], varEmpty);
    AddSet(TCustomDBGrid, 'SelectedField', TCustomDBGrid_Write_SelectedField, 0, [0]);
    AddGet(TCustomDBGrid, 'SelectedIndex', TCustomDBGrid_Read_SelectedIndex, 0, [0], varEmpty);
