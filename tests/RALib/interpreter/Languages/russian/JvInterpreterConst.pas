...
{JvInterpreterParser}
 {$IFDEF Delphi}
  ...
  StIdFirstSymbols = ['_', 'A'..'Z', 'a'..'z', 'À'..'ß', 'à'..'ÿ'];
  StConstSymbols   = ['0'..'9', 'A'..'F', 'a'..'f'];
  StConstSymbols10 = ['0'..'9'];
  StSeparators     = ['(', ')', ',', '.', ';'];
 {$ENDIF Delphi}
 {$IFDEF BCB}
  StIdSymbols      = '_0123456789QWERTYUIOPASDFGHJKLZXCVBNMqwertyuiopasdfghjklzxcvbnmÉÖÓÊÅÍÃØÙÇÕÚÔÛÂÀÏĞÎËÄÆİß×ÑÌÈÒÜÁŞ¨éöóêåíãøùçõúôûâàïğîëäæıÿ÷ñìèòüáş¸';
  StIdFirstSymbols = '_QWERTYUIOPASDFGHJKLZXCVBNMqwertyuiopasdfghjklzxcvbnmÉÖÓÊÅÍÃØÙÇÕÚÔÛÂÀÏĞÎËÄÆİß×ÑÌÈÒÜÁŞ¨éöóêåíãøùçõúôûâàïğîëäæıÿ÷ñìèòüáş¸';
 ...
 {JvInterpreterFm}
  SNoReportProc = 'Íå íàéäåíà ïğîöåäóğà "JvInterpreterRunReportPreview"';
  SNoReportProc2 = 'Íå íàéäåíà ïğîöåäóğà "JvInterpreterRunReportPreview2"';
