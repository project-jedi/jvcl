...
procedure TfrmMain.ChooserCatChange(Sender: TObject);
begin
  with FChooser do
...
function TfrmMain.IsWithinBounds(Category: Integer): Boolean;
begin
...
procedure TfrmMain.LinkLabelLinkClick(Sender: TObject; LinkNumber: Integer;
  LinkText: String);
var
  frmPlay: TfrmPlay;
