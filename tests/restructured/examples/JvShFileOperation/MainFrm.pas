...
type
  TfrmMain = class(TForm)
    ...
    chkUndo: TJvCheckBox;
    chkFiles: TJvCheckBox;
    chkMulti: TJvCheckBox;
    chkNoConfirm: TJvCheckBox;
    chkNoDirCreate: TJvCheckBox;
    chkRename: TJvCheckBox;
    chkSilent: TJvCheckBox;
    chkSimple: TJvCheckBox;
    chkMappings: TJvCheckBox;
    chkNoErrors: TJvCheckBox;
    JvBevel1: TJvBevel;
    JvLabel3: TJvLabel;
    memMessages: TJvMemo;
    Label1: TLabel;
