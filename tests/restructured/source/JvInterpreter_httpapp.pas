...
procedure JvInterpreter_DosPathToUnixPath(var Value: Variant; Args: TArgs);
begin
  Value := DosPathToUnixPath(Args.Values[0]);
end;

{ function HTTPDecode(const AStr: String): string; }
procedure JvInterpreter_HTTPDecode(var Value: Variant; Args: TArgs);
begin
  Value := HTTPDecode(Args.Values[0]);
end;

{ function HTTPEncode(const AStr: String): string; }
procedure JvInterpreter_HTTPEncode(var Value: Variant; Args: TArgs);
begin
  Value := HTTPEncode(Args.Values[0]);
end;

{ function ParseDate(const DateStr: string): TDateTime; }
procedure JvInterpreter_ParseDate(var Value: Variant; Args: TArgs);
begin
  Value := ParseDate(Args.Values[0]);
end;

{ function StatusString(StatusCode: Integer): string; }
procedure JvInterpreter_StatusString(var Value: Variant; Args: TArgs);
begin
  Value := StatusString(Args.Values[0]);
end;

{ function UnixPathToDosPath(const Path: string): string; }
procedure JvInterpreter_UnixPathToDosPath(var Value: Variant; Args: TArgs);
begin
  Value := UnixPathToDosPath(Args.Values[0]);
end;

{ function MonthStr(DateTime: TDateTime): string; }
procedure JvInterpreter_MonthStr(var Value: Variant; Args: TArgs);
begin
  Value := MonthStr(Args.Values[0]);
end;

{ function DayOfWeekStr(DateTime: TDateTime): string; }
procedure JvInterpreter_DayOfWeekStr(var Value: Variant; Args: TArgs);
begin
...
begin
  ...
  begin
   { TWebRequest }
    ...
    AddGet(TWebRequest, 'MethodType', TWebRequest_Read_MethodType, 0, [0], varEmpty);
    AddGet(TWebRequest, 'ContentFields', TWebRequest_Read_ContentFields, 0, [0], varEmpty);
    AddGet(TWebRequest, 'CookieFields', TWebRequest_Read_CookieFields, 0, [0], varEmpty);
    AddGet(TWebRequest, 'QueryFields', TWebRequest_Read_QueryFields, 0, [0], varEmpty);
    AddGet(TWebRequest, 'Method', TWebRequest_Read_Method, 0, [0], varEmpty);
    AddGet(TWebRequest, 'ProtocolVersion', TWebRequest_Read_ProtocolVersion, 0, [0], varEmpty);
    AddGet(TWebRequest, 'URL', TWebRequest_Read_URL, 0, [0], varEmpty);
    AddGet(TWebRequest, 'Query', TWebRequest_Read_Query, 0, [0], varEmpty);
    AddGet(TWebRequest, 'PathInfo', TWebRequest_Read_PathInfo, 0, [0], varEmpty);
    AddGet(TWebRequest, 'PathTranslated', TWebRequest_Read_PathTranslated, 0, [0], varEmpty);
    AddGet(TWebRequest, 'Authorization', TWebRequest_Read_Authorization, 0, [0], varEmpty);
    AddGet(TWebRequest, 'CacheControl', TWebRequest_Read_CacheControl, 0, [0], varEmpty);
    AddGet(TWebRequest, 'Cookie', TWebRequest_Read_Cookie, 0, [0], varEmpty);
    AddGet(TWebRequest, 'Date', TWebRequest_Read_Date, 0, [0], varEmpty);
    AddGet(TWebRequest, 'Accept', TWebRequest_Read_Accept, 0, [0], varEmpty);
    AddGet(TWebRequest, 'From', TWebRequest_Read_From, 0, [0], varEmpty);
    AddGet(TWebRequest, 'Host', TWebRequest_Read_Host, 0, [0], varEmpty);
    AddGet(TWebRequest, 'IfModifiedSince', TWebRequest_Read_IfModifiedSince, 0, [0], varEmpty);
    AddGet(TWebRequest, 'Referer', TWebRequest_Read_Referer, 0, [0], varEmpty);
    AddGet(TWebRequest, 'UserAgent', TWebRequest_Read_UserAgent, 0, [0], varEmpty);
    AddGet(TWebRequest, 'ContentEncoding', TWebRequest_Read_ContentEncoding, 0, [0], varEmpty);
    AddGet(TWebRequest, 'ContentType', TWebRequest_Read_ContentType, 0, [0], varEmpty);
    AddGet(TWebRequest, 'ContentLength', TWebRequest_Read_ContentLength, 0, [0], varEmpty);
    AddGet(TWebRequest, 'ContentVersion', TWebRequest_Read_ContentVersion, 0, [0], varEmpty);
    AddGet(TWebRequest, 'Content', TWebRequest_Read_Content, 0, [0], varEmpty);
    AddGet(TWebRequest, 'Connection', TWebRequest_Read_Connection, 0, [0], varEmpty);
    AddGet(TWebRequest, 'DerivedFrom', TWebRequest_Read_DerivedFrom, 0, [0], varEmpty);
    AddGet(TWebRequest, 'Expires', TWebRequest_Read_Expires, 0, [0], varEmpty);
    AddGet(TWebRequest, 'Title', TWebRequest_Read_Title, 0, [0], varEmpty);
    AddGet(TWebRequest, 'RemoteAddr', TWebRequest_Read_RemoteAddr, 0, [0], varEmpty);
    AddGet(TWebRequest, 'RemoteHost', TWebRequest_Read_RemoteHost, 0, [0], varEmpty);
    AddGet(TWebRequest, 'ScriptName', TWebRequest_Read_ScriptName, 0, [0], varEmpty);
    AddGet(TWebRequest, 'ServerPort', TWebRequest_Read_ServerPort, 0, [0], varEmpty);
   { TCookie }
    ...
    AddGet(TCookie, 'Name', TCookie_Read_Name, 0, [0], varEmpty);
    AddSet(TCookie, 'Name', TCookie_Write_Name, 0, [0]);
    AddGet(TCookie, 'Value', TCookie_Read_Value, 0, [0], varEmpty);
    AddSet(TCookie, 'Value', TCookie_Write_Value, 0, [0]);
    AddGet(TCookie, 'Domain', TCookie_Read_Domain, 0, [0], varEmpty);
    AddSet(TCookie, 'Domain', TCookie_Write_Domain, 0, [0]);
    AddGet(TCookie, 'Path', TCookie_Read_Path, 0, [0], varEmpty);
    AddSet(TCookie, 'Path', TCookie_Write_Path, 0, [0]);
    AddGet(TCookie, 'Expires', TCookie_Read_Expires, 0, [0], varEmpty);
    AddSet(TCookie, 'Expires', TCookie_Write_Expires, 0, [0]);
    AddGet(TCookie, 'Secure', TCookie_Read_Secure, 0, [0], varEmpty);
    AddSet(TCookie, 'Secure', TCookie_Write_Secure, 0, [0]);
    AddGet(TCookie, 'HeaderValue', TCookie_Read_HeaderValue, 0, [0], varEmpty);
   { TWebResponse }
    ...
    AddGet(TWebResponse, 'SendResponse', TWebResponse_SendResponse, 0, [0], varEmpty);
    ...
    AddGet(TWebResponse, 'Sent', TWebResponse_Sent, 0, [0], varEmpty);
    AddGet(TWebResponse, 'SetCookieField', TWebResponse_SetCookieField, 5, [varObject, varString, varString, varEmpty, varBoolean], varEmpty);
    AddGet(TWebResponse, 'SetCustomHeader', TWebResponse_SetCustomHeader, 2, [varString, varString], varEmpty);
    AddGet(TWebResponse, 'Cookies', TWebResponse_Read_Cookies, 0, [0], varEmpty);
    AddGet(TWebResponse, 'HTTPRequest', TWebResponse_Read_HTTPRequest, 0, [0], varEmpty);
    AddGet(TWebResponse, 'Version', TWebResponse_Read_Version, 0, [0], varEmpty);
    AddSet(TWebResponse, 'Version', TWebResponse_Write_Version, 0, [0]);
    AddGet(TWebResponse, 'ReasonString', TWebResponse_Read_ReasonString, 0, [0], varEmpty);
    AddSet(TWebResponse, 'ReasonString', TWebResponse_Write_ReasonString, 0, [0]);
    AddGet(TWebResponse, 'Server', TWebResponse_Read_Server, 0, [0], varEmpty);
    AddSet(TWebResponse, 'Server', TWebResponse_Write_Server, 0, [0]);
    AddGet(TWebResponse, 'WWWAuthenticate', TWebResponse_Read_WWWAuthenticate, 0, [0], varEmpty);
    AddSet(TWebResponse, 'WWWAuthenticate', TWebResponse_Write_WWWAuthenticate, 0, [0]);
    AddGet(TWebResponse, 'Realm', TWebResponse_Read_Realm, 0, [0], varEmpty);
    AddSet(TWebResponse, 'Realm', TWebResponse_Write_Realm, 0, [0]);
    AddGet(TWebResponse, 'Allow', TWebResponse_Read_Allow, 0, [0], varEmpty);
    AddSet(TWebResponse, 'Allow', TWebResponse_Write_Allow, 0, [0]);
    AddGet(TWebResponse, 'Location', TWebResponse_Read_Location, 0, [0], varEmpty);
    AddSet(TWebResponse, 'Location', TWebResponse_Write_Location, 0, [0]);
    AddGet(TWebResponse, 'ContentEncoding', TWebResponse_Read_ContentEncoding, 0, [0], varEmpty);
    AddSet(TWebResponse, 'ContentEncoding', TWebResponse_Write_ContentEncoding, 0, [0]);
    AddGet(TWebResponse, 'ContentType', TWebResponse_Read_ContentType, 0, [0], varEmpty);
    AddSet(TWebResponse, 'ContentType', TWebResponse_Write_ContentType, 0, [0]);
    AddGet(TWebResponse, 'ContentVersion', TWebResponse_Read_ContentVersion, 0, [0], varEmpty);
    AddSet(TWebResponse, 'ContentVersion', TWebResponse_Write_ContentVersion, 0, [0]);
    AddGet(TWebResponse, 'DerivedFrom', TWebResponse_Read_DerivedFrom, 0, [0], varEmpty);
    AddSet(TWebResponse, 'DerivedFrom', TWebResponse_Write_DerivedFrom, 0, [0]);
    AddGet(TWebResponse, 'Title', TWebResponse_Read_Title, 0, [0], varEmpty);
    AddSet(TWebResponse, 'Title', TWebResponse_Write_Title, 0, [0]);
    AddGet(TWebResponse, 'StatusCode', TWebResponse_Read_StatusCode, 0, [0], varEmpty);
    AddSet(TWebResponse, 'StatusCode', TWebResponse_Write_StatusCode, 0, [0]);
    AddGet(TWebResponse, 'ContentLength', TWebResponse_Read_ContentLength, 0, [0], varEmpty);
    AddSet(TWebResponse, 'ContentLength', TWebResponse_Write_ContentLength, 0, [0]);
    AddGet(TWebResponse, 'Date', TWebResponse_Read_Date, 0, [0], varEmpty);
    AddSet(TWebResponse, 'Date', TWebResponse_Write_Date, 0, [0]);
    AddGet(TWebResponse, 'Expires', TWebResponse_Read_Expires, 0, [0], varEmpty);
    AddSet(TWebResponse, 'Expires', TWebResponse_Write_Expires, 0, [0]);
    AddGet(TWebResponse, 'LastModified', TWebResponse_Read_LastModified, 0, [0], varEmpty);
    AddSet(TWebResponse, 'LastModified', TWebResponse_Write_LastModified, 0, [0]);
    AddGet(TWebResponse, 'Content', TWebResponse_Read_Content, 0, [0], varEmpty);
    AddSet(TWebResponse, 'Content', TWebResponse_Write_Content, 0, [0]);
    AddGet(TWebResponse, 'ContentStream', TWebResponse_Read_ContentStream, 0, [0], varEmpty);
    AddSet(TWebResponse, 'ContentStream', TWebResponse_Write_ContentStream, 0, [0]);
    AddGet(TWebResponse, 'LogMessage', TWebResponse_Read_LogMessage, 0, [0], varEmpty);
    AddSet(TWebResponse, 'LogMessage', TWebResponse_Write_LogMessage, 0, [0]);
    AddGet(TWebResponse, 'CustomHeaders', TWebResponse_Read_CustomHeaders, 0, [0], varEmpty);
   ...
   { TWebActionItem }
    ...
    AddGet(TWebActionItem, 'Default', TWebActionItem_Read_Default, 0, [0], varEmpty);
    AddSet(TWebActionItem, 'Default', TWebActionItem_Write_Default, 0, [0]);
    AddGet(TWebActionItem, 'Enabled', TWebActionItem_Read_Enabled, 0, [0], varEmpty);
    AddSet(TWebActionItem, 'Enabled', TWebActionItem_Write_Enabled, 0, [0]);
    AddGet(TWebActionItem, 'MethodType', TWebActionItem_Read_MethodType, 0, [0], varEmpty);
    AddSet(TWebActionItem, 'MethodType', TWebActionItem_Write_MethodType, 0, [0]);
    AddGet(TWebActionItem, 'Name', TWebActionItem_Read_Name, 0, [0], varEmpty);
   ...
   { TWebDispatcher }
    ...
    AddFun('httpapp', 'HTTPDecode', JvInterpreter_HTTPDecode, 1, [varString], varEmpty);
    AddFun('httpapp', 'HTTPEncode', JvInterpreter_HTTPEncode, 1, [varString], varEmpty);
    AddFun('httpapp', 'ParseDate', JvInterpreter_ParseDate, 1, [varString], varEmpty);
    AddFun('httpapp', 'StatusString', JvInterpreter_StatusString, 1, [varInteger], varEmpty);
    AddFun('httpapp', 'UnixPathToDosPath', JvInterpreter_UnixPathToDosPath, 1, [varString], varEmpty);
    AddFun('httpapp', 'MonthStr', JvInterpreter_MonthStr, 1, [varEmpty], varEmpty);
    AddFun('httpapp', 'DayOfWeekStr', JvInterpreter_DayOfWeekStr, 1, [varEmpty], varEmpty);
  end;    { with }
