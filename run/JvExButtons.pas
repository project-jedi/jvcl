...
procedure TJvExSpeedButton.FocusChanged(Control: TWinControl);
begin
end;
...
procedure TJvExBitBtn.FocusChanged(Control: TWinControl);
begin
end;
...
function TJvExBitBtn.PaintBackground(Canvas: TCanvas; Param: Integer): Boolean;
asm
