...
function TJvAppXMLStorage.ReadValue(const NodeName,
  Attribute: string): string;
begin
  Result := FXml.Root.Items.ItemNamed[NodeName].Items.ItemNamed[Attribute].Value;
end;

procedure TJvAppXMLStorage.RemoveValue(const NodeName, Attribute: string);
begin
  FXml.Root.Items.ItemNamed[NodeName].Items.Delete(Attribute);
end;

function TJvAppXMLStorage.ValueExists(const NodeName, Attribute: string): Boolean;
var
...
procedure TJvAppXMLStorage.WriteValue(const NodeName, Attribute, Value: string);
var
  Node: TJvSimpleXmlElem;
