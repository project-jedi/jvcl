...
{$IFDEF COMPILER6_UP}
type
  TXMLVariant = JclSimpleXml.TXMLVariant deprecated; // use JclSimpleXml.TXMLVariant

  TXMLVarData = JclSimpleXML.TXMLVarData deprecated; // JclSimpleXML.TXMLVarData
...
function SimpleXMLEncode(const S: string): string; deprecated; // use JclSimpleXml.SimpleXMLEncode
...
procedure SimpleXMLDecode(var S: string; TrimBlanks: Boolean); deprecated; // use JclSimpleXml.SimpleXMLDecode

function XMLEncode(const S: string): string; deprecated; // use JclSimpleXml.XMLEncode
function XMLDecode(const S: string): string; deprecated; // use JclSimpleXml.XMLDecode

// Encodes special characters (', ", <, > and &) into XML entities (@apos;, &quot;, &lt;, &gt; and &amp;)
function EntityEncode(const S: string): string; deprecated; // use JclSimpleXml.EntityEncode
// Decodes XML entities (@apos;, &quot;, &lt;, &gt; and &amp;) into special characters (', ", <, > and &)
function EntityDecode(const S: string): string; deprecated; // use JclSimpleXml.EntityDecode
