...
uses
  ...
  QComCtrls, QExtCtrls, QStdCtrls, QCheckLst,
  JclBase, JvQDSADialogs;
...
begin
{
  ...
  imgWarning.Picture.Icon.assign(DlgPic(mtWarning));
  imgError.Picture.Icon.assign(DlgPic(mtError));
  imgInformation.Picture.assign(DlgPic(mtInformation));
  imgConfirmation.Picture.Icon.assign(DlgPic(mtInformation));
  ...
  begin
    ...
    try
      ...
      case PicType of
        ...
        1 .. 4:
          imgCustom.Picture.Icon.Assign(DlgPic(TMsgDlgType(PicType)));
        5:
          try
