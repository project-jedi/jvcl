...
uses
  ...
  QMenus, QStdCtrls, JvQFindReplace, JvQDSADialogs, JvQComponent, QExtCtrls, QTypes;
...
{$R *.xfm}
function DualInputQuery(const ACaption, Prompt1, Prompt2:string; var AValue1, AValue2:widestring):boolean;
var
  AForm:TForm;
...
//rs   FindReplace1.Keeptext := Rememberlastsearch1.Checked;
end;
