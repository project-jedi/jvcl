...
uses
  QWindows, SysUtils, QMessages, Classes, Types, QGraphics, QControls,
  QForms, QDialogs, QExtCtrls, QStdCtrls, QButtons, Spin,
...
uses JvQJVCLAboutForm, // JVCL About box stuff. COMMENT OUT THIS LINE IF NOT FOUND!
     JvQDsgnConsts,    // JVCL About box stuff. COMMENT OUT THIS LINE IF NOT FOUND!
     JVCLXVer,         // JVCL About box stuff. COMMENT OUT THIS LINE IF NOT FOUND!  
...
begin
  ...
  'JvChart comes from AABSoft Graph written by  Mårten Henrichson, JVCLX 1.0 '+
  'version by Warren Postma.  ','About JvChart', [smbOK]);
end;
